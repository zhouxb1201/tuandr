...
class Config extends BaseService
{
     ...
     */
    public function updateNoticeTemplate($is_enable, $template_type,$template_code, $template_content, $template_title, $notify_type, $notification_mode)
    {
    ...
    public function getPayConfig($shop_id)
    {
        ...
        $condition = array(
            ...
            'key' => array(
                'in',
                'WPAY,ALIPAY,BPAY,DPAY,ETHPAY,EOSPAY,TLPAY'
            )
        );
        $notify_list = $config_model->getQuery($condition, "*", "");
        if (!empty($notify_list)) {
     ...
     *
    */
    public function setShopConfig($shop_id, $order_auto_delivery,$convert_rate, $order_delivery_complete_time, $order_buy_close_time, $shopping_back_points, $point_invoice_tax, $is_point, $integral_calculation,$is_point_deduction,$point_deduction_calculation,$point_deduction_max,$is_translation,$translation_time,$translation_text, $is_transfer,$is_transfer_charge,$charge_type,$charge_pares,$charge_pares_min,$charge_pares2, $is_point_transfer,$is_point_transfer_charge,$point_charge_type,$point_charge_pares,$point_charge_pares_min,$point_charge_pares2)
    {
        $array[0] = array(
            'instance_id' => $shop_id,
            'website_id' => $this->website_id,
