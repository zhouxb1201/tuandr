<template>
  <PopupBottom v-model="show">
    <div slot="title" class="van-hairline--top-bottom van-actionsheet__header title">
    ...
    <van-radio-group v-model="active" class="list" @change="change">
      <van-cell-group :border="false" title="快递配送" class="cell-group-address">
        <van-cell clickable>
      ...
      <van-cell-group :border="false" title="门店自提" class="cell-group-store" v-if="list.length">
