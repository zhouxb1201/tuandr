<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/www.tuandr.com/addons/bargain/template/platform/bargainList.html";i:1583811704;}*/ ?>


<div class="mb-20">
    <a href="<?php echo __URL('platform/Menu/addonmenu?addons=addBargain'); ?>" class="btn btn-primary"><i class="icon icon-add1"></i>
        添加砍价</a>
