<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"template/admin/Shop/createWapTemplate.html";i:1583811760;}*/ ?>
    ...
    require(['util'], function (util) {
        ...
        function getSystemTemplateList() {
            $.ajax({
                type: "post",
                async: false,
                url: __URL("ADMIN_MAIN/config/getSystemDefaultTemplateList"),
        ...
        $('#content_type').on('click', '.J-create', function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.code > 0) {
                        window.location = __URL("ADMIN_MAIN/config/customtemplate?id=" + res.data.id)
