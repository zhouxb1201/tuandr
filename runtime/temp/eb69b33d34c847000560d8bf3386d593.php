<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"/www/wwwroot/www.tuandr.com/addons/store/template/admin/addJobs.html";i:1583811702;}*/ ?>
                ...
                success: function (data) {
                    if (data["code"] > 0) {
                        utilAdmin.message(data["message"], 'success',function(){
                            window.location.href="<?php echo __URL('ADDONS_ADMIN_MAINjobsList'); ?>";
                        });
                    } else {
