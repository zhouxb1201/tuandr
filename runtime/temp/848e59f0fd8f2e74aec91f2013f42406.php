<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:46:"template/platform/Member/memberGroupLists.html";i:1591330110;}*/ ?>
<div class="goods-dialog">
    ...
    <div>
        ...
        <input type="text" class="form-control goods_val J-admin_name" value="<?php echo $default_group_name; ?>" name="goods_val" disabled>
    </div>
    <input type="hidden" id="group_id">
    <input type="hidden" id="default_uid" value="<?php echo $default_uid; ?>">
    <input type="hidden" id="default_group_id" value="<?php echo $default_group_id; ?>">
</div>
<script>
    require(['util'],function(util){
        ...
        function getList(){
            $.ajax({
                type : "POST",
                url : "<?php echo __URL('PLATFORM_MAIN/member/memberGroupLists'); ?>",
                data : {
