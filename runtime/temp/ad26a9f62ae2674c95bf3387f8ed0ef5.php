<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"template/platform/Member/memberGroupList.html";i:1591330110;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="v-container">
            ...
            <?php endif; ?>
                ...
                <div class="flex mb-10 PAmaterial" id="mat_type1"><!-- page -->
                    <a href="<?php echo __URL('PLATFORM_MAIN/member/addLabel'); ?>"  class="btn btn-primary dropdown-toggle">添加标签</a>
                </div>
...
require(['util'],function(util){
    ...
    function getList(page_index){
        ...
        $.ajax({
            type : "post",
            url : "<?php echo __URL('PLATFORM_MAIN/member/memberGroupList'); ?>",
            async : true,
            data : {
    ...
    $('body').on('click','.delGroup',function(){
        ...
        if(group_id){
            util.alert('确认删除？',function() {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo __URL('PLATFORM_MAIN/member/delGroup'); ?>",
                    async: true,
                    data: {
                        "group_id": group_id,
                    },
    ...
    $('body').on('blur','.updateGroupName',function(){
        ...
        if(group_name_default!=group_name){
            $.ajax({
                type : "post",
                url : "<?php echo __URL('PLATFORM_MAIN/member/updateGroupName'); ?>",
                async : true,
                data : {
                    "group_id" : group_id,
    ...
    $('body').on('blur','.addGroupName',function(){
        ...
        $.ajax({
            type : "post",
            url : "<?php echo __URL('PLATFORM_MAIN/member/addGroup'); ?>",
            async : true,
            data : {
                "group_name" : group_name
            },
