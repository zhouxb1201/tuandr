<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"/www/wwwroot/www.tuandr.com/addons/integral/template/platform/integralGoodsList.html";i:1583811704;}*/ ?>
...
<ul class="nav nav-tabs v-nav-tabs fs-12">
    <li role="presentation" <?php if(!$type): ?> class="active" <?php endif; ?>><a href="<?php echo __URL('platform/Menu/addonmenu?addons=integralGoodsList'); ?>" class="flex-auto-center">全部<br><span class="J-all"></span></a></li>
    <li role="presentation" <?php if($type == 1): ?> class="active" <?php endif; ?>><a href="<?php echo __URL('platform/Menu/addonmenu?addons=integralGoodsList'); ?>&type=1" class="flex-auto-center">出售中<br><span class="J-online"></span></a></li>
    <li role="presentation" <?php if($type == 2): ?> class="active" <?php endif; ?>><a href="<?php echo __URL('platform/Menu/addonmenu?addons=integralGoodsList'); ?>&type=2" class="flex-auto-center">仓库中<br><span class="J-offline"></span></a></li>
    <li role="presentation" <?php if($type == 3): ?> class="active" <?php endif; ?>><a href="<?php echo __URL('platform/Menu/addonmenu?addons=integralGoodsList'); ?>&type=3" class="flex-auto-center">已售聲<br><span class="J-soldout"></span></a></li>
    <li role="presentation" <?php if($type == 4): ?> class="active" <?php endif; ?>><a href="<?php echo __URL('platform/Menu/addonmenu?addons=integralGoodsList'); ?>&type=4" class="flex-auto-center">库存预警<br><span class="J-alarm"></span></a></li>
</ul>
<div class="mb-10 flex flex-pack-justify">
    <div class="">
        <a href="<?php echo __URL('platform/Menu/addonmenu?addons=addIntegralGoods'); ?>" class="btn btn-primary"><i class="icon icon-add1"></i> 发布商品</a>
    ...
    <div class="flex">
        ...
        <div class="input-group search-input-group ml-10">
            <input type="text" class="form-control" placeholder="商品名称"  id="goods_name" value="<?php echo $search_info; ?>">
...
//      var state = $("#state").val();
            ...
            $.ajax({
                type: "post",
                url: "<?php echo $selfIntegralgoodsList; ?>",
                data: {
...
//              "state": state,
                ...
                success: function (data) {
                    ...
                    if (data["data"].length > 0) {
                        for (var i = 0; i < data["data"].length; i++) {
                            ...
                            html += '<a class="btn-operation" href="'+"<?php echo __URL('platform/Menu/addonmenu?addons=addIntegralGoods'); ?>&goods_id="+data["data"][i]["goods_id"]+'&goods_type=' + goods_type + '">编辑</a>';
        ...
        $("body").on('click', '.deleteGood', function(){
            ...
            util.alert('是否删除此商品？',function(){
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo $deleteIntegralGoods; ?>",
        ...
        function goodListEdit(){
            ...
            $(".goodsEdit").on("blur",".edit_price",function(){
                ...
                $.ajax({
                    ...
                    url: "<?php echo $integralQuiklyEdit; ?>",
                    success: function (data) {
                        if(data['code']){
        ...
        $("body").on('click', '.online', function(){
            ...
            $.ajax({
                type: "post",
                url: "<?php echo $modifyIntegralGoodsOnline; ?>",
                data: {"goods_ids": goodsId.toString()},
                dataType: "json",
                async : true,
                success : function(data) {
        ...
        $('body').on('click', '.outline', function(){
            ...
            $.ajax({
                type: "post",
                url: "<?php echo $modifyIntegralGoodsOutline; ?>",
                data: {"goods_ids": goodsId.toString()},
                dataType: "json",
                async : true,
                success : function(data) {
        ...
        function getgoodscount(){
            $.ajax({
                type: "post",
                url: "<?php echo $getIntegralGoodsCount; ?>",
                success: function (data) {
                    $('.J-all').html('('+data.all+')');
