<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"template/platform/Statistics/userStat.html";i:1591330113;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="v-main">
        <div class="v-container">
            ...
            <?php endif; ?>
                ...
                <!-- page  -->
                <input type="hidden" id="start_time" value="<?php echo $start_date; ?>">
                <input type="hidden" id="end_time" value="<?php echo $end_date; ?>">
                <div class="mb-20 flex flex-pack-justify flex-align-center">
                    <p>今日新增会员：<?php echo $user_today_num; ?> | 本月新增会员：<?php echo $user_month_num; ?> | 平台总会员：<?php echo $user_count_num; ?></p>
...
require(['util'],function(util){
    ...
    $.ajax({
        type : "post",
        url : "<?php echo __URL('PLATFORM_MAIN/statistics/getMemberMonthCount'); ?>",
