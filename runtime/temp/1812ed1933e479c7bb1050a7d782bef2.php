<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"template/platform/Goods/addGoodsBrand.html";i:1591330108;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    require(['util'], function (util) {
        ...
        util.validate($('.form-validate'), function (form) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo __URL('PLATFORM_MAIN/goods/addgoodsbrand'); ?>",
                data: {
                ...
                success: function (data) {
                    if (data["code"] > 0) {
                        util.message('商品品牌添加成功', "success", "<?php echo __URL('PLATFORM_MAIN/goods/goodsbrandlist'); ?>");
                    } else {
