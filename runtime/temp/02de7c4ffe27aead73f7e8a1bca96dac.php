<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:38:"template/admin/Auth/authGroupList.html";i:1583811758;s:24:"template/admin/base.html";i:1591103601;s:41:"template/admin/controlCommonVariable.html";i:1583811758;s:28:"template/admin/urlModel.html";i:1583811758;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="mb-20 flex flex-pack-justify">
    <div class="">
        <a href="<?php echo __URL('ADMIN_MAIN/auth/addusergroup'); ?>" class="btn btn-primary J-add"><i class="icon icon-add1"></i> 添加角色</a>
    </div>
</div>
<!--表格-->
