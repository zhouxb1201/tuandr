<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"/www/wwwroot/www.tuandr.com/addons/gift/template/admin/giftList.html";i:1583811696;}*/ ?>

<!-- page -->
<!--<div class="mb-20">
    <a href="<?php echo __URL('ADDONS_ADMIN_MAINaddGift'); ?>" class="btn btn-primary"><i class="icon icon-add1"></i> 添加赠品</a>
