<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/www/wwwroot/www.tuandr.com/addons/pcport/template/platform/pcportSetting.html";i:1583811696;}*/ ?>
    ...
    require(['util'], function (util) {
        ...
        $('body').on('click','.wLogin_set',function(){
            ...
            util.confirm('微信登录配置',html,function(){
                ...
                $.ajax({
                    type:"post",
                    url:"<?php echo $loginWeiXinConfigUrl; ?>",
                    data:{
                        'appkey':appkey,
                        'appsecret':appsecret,
                        'url':url,
        ...
        //     html += '<div class="form-group"><label class="col-md-3 control-label"><span class="text-bright">*</span>申请域名</label><div class="col-md-8"><div class="input-group"><input style="opacity: 0;position: absolute; z-index: -11;" type="text" class="form-control" id="QQ_AUTHORIZE" value="<?php echo $apply_realm; ?>"><input class="form-control" value="<?php echo $apply_realm; ?>" disabled type="text"><span class="input-group-btn copy4"><a href="javascript:void(0);" class="btn btn-default">复制</a></span></div></div></div>';
        //     html += '<div class="form-group"><label class="col-md-3 control-label"><span class="text-bright">*</span>回调域名</label><div class="col-md-8"><div class="input-group"><input style="opacity: 0;position: absolute; z-index: -11;" type="text" class="form-control" id="QQ_CALLBACK" value="https://<?php echo $apply_back_realm; ?>"><input class="form-control" value="https://<?php echo $apply_back_realm; ?>" disabled type="text"><span class="input-group-btn copy5"><a href="javascript:void(0);" class="btn btn-default">复制</a></span></div></div></div>';
        //     html += '</div>';
        //     html += '</form>';
        //     loading('thirdParty');
        ...
        //         $.ajax({
        //             type:"post",
        //             url:"<?php echo __URL('PLATFORM_MAIN/config/loginQqConfig'); ?>",
        //             data:{
        //                 'appkey':appkey,
        //                 'appsecret':appsecret,
        //                 'url':url,
