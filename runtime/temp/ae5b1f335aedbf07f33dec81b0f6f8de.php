<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"/www/wwwroot/www.tuandr.com/addons/groupshopping/template/platform/groupShoppingDetail.html";i:1583811704;}*/ ?>
            ...
            <table class="table v-table table-auto-center table-bordered">
                <tbody>
                    <tr>
                        ...
                        <td class="text-left">
                            <p><?php echo $groupDetail['group_name']; ?></p>
                        </td>
                    </tr>
                    <tr>
                        <td class="col-md-3 bg-f5">
                        ...
                        <td class="text-left">
                            <p><?php echo $groupDetail['group_num']; ?></p>
                        </td>
                    </tr>
                    <tr>
                        <td class="col-md-3 bg-f5">
                        ...
                        <td class="text-left">
                            <p><?php echo $groupDetail['group_time']; ?>分钟</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="col-md-3 bg-f5">
                    ...
                    <tr>
                        ...
                        <td class="text-left">
                            <p><?php if(!$groupDetail['status']): ?>待开始<?php elseif($groupDetail['status']=='1'): ?>进行中<?php else: ?>已结束<?php endif; ?></p>
                        </td>
                    </tr>
                </tbody>
            </table>
            </div>
            <div id="sku_list" data-sku_list="<?php echo $groupDetail['sku_list']; ?>">
    ...
    require(['util'], function (util) {
        ...
        function setSku(obj){
            ...
            if(sku_list.length > 1){
                ...
                $('#group_price').html(sku_list[0].group_price);
                $('#group_limit_buy').html(sku_list[0].group_limit_buy);
