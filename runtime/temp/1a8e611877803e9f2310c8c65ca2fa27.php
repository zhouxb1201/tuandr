<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"/www/wwwroot/www.tuandr.com/addons/groupshopping/template/platform/addGroupShopping.html";i:1583811704;}*/ ?>
    ...
    require(['util'], function (util) {
        ...
        util.validate($('.form-validate'), function (form) {
            ...
            $.post('<?php echo $addGroupShoppingUrl; ?>',
                    ...
                    function(res){
                    if (res["code"] > 0) {
                        util.message('添加成功', 'success', "<?php echo __URL('ADDONS_MAINgroupShoppingList'); ?>");
                    } else {
