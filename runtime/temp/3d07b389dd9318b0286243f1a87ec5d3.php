<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:34:"template/admin/Menu/addonmenu.html";i:1583811758;s:24:"template/admin/base.html";i:1591103601;s:41:"template/admin/controlCommonVariable.html";i:1583811758;s:28:"template/admin/urlModel.html";i:1583811758;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="v-subnav">
    ...
    <li>
        <a href="<?php echo __URL('ADMIN_MAIN/'.$v1['url']); ?>" <?php if(strtoupper($v1['method']) == strtoupper($action)): ?> class="item active"<?php else: ?> class="item"<?php endif; ?>> <?php echo $v1['module_name']; ?></a>
    </li>
...
<div class="v-subnav">
    ...
    <ul class="v-subnav-list block" id="menu_<?php echo $vo['module_id']; ?>" >
        ...
        <li>
            <a href="<?php echo __URL('ADMIN_MAIN/'.$vo['url']); ?>" <?php if(strtoupper($vo['method']) == strtoupper($action)): ?> class="item active"<?php else: ?> class="item"<?php endif; ?>> <?php echo $vo['module_name']; ?></a>
        </li>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
</div>
