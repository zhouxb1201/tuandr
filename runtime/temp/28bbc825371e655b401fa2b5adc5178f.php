<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"/www/wwwroot/www.tuandr.com/addons/miniprogram/template/admin/miniProgramCustom.html";i:1583811700;s:91:"/www/wwwroot/www.tuandr.com/addons/miniprogram/template/common/customEditTemplateAdmin.html";i:1583811700;s:86:"/www/wwwroot/www.tuandr.com/addons/miniprogram/template/common/customViewTemplate.html";i:1586931646;}*/ ?>
<script src="../../../../public/platform/js/config.js"></script>
            ...
            <div class="custom-header-list-box">
                <div class="box-head flex-center-justify">
                    ...
                    <div class="">
                        ...
                        <a href="<?php echo __URL('ADDONS_ADMIN_MAINminiProgramCustomList'); ?>" class="btn btn-default btn-sm">管理页面</a>
                    </div>
                </div>
                <div class="box-main">
                    <div class="box-main-left">
                        ...
                        <ul class="list">
                            ...
                            <li class="item"><a href="<?php echo __URL('ADDONS_ADMIN_MAINminiProgramCustom&id='.$list['id']); ?>"><?php echo $list['template_name']; ?></a></li>
...
<!--    </div>-->
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <label class="radio-inline"><input type="radio" name="goodstype" value="2" class="diy-bind" data-bind-child="params" data-bind="goodstype" data-bind-init="true" checked="checked"> 店铺商品</label>
...
<!-- 视图 end -->
<script>
    require(['admin_mp_custom','tpl','utilAdmin'],function(modal,tpl,util){
