<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:36:"template/platform/Auth/userList.html";i:1591330104;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="v-container">
            ...
            <?php endif; ?>
                ...
                <div class="mb-20 flex flex-pack-justify">
                    <div class="">
                        <a href="<?php echo __URL('PLATFORM_MAIN/Auth/addUser'); ?>" class="btn btn-primary"><i class="icon icon-add1"></i> 添加子账号</a>
                    </div>
...
require(['util'],function(util){
    ...
    function del(){
        $('.del').click(function(e){
            ...
            util.alert('是否确定删除此管理员吗？',function(){
                $.ajax({
                    type : "post",
                    url : "<?php echo __URL('PLATFORM_MAIN/Auth/delUser'); ?>",
                    async : true,
                    data : {
                        "uid" : id
                    },
            ...
            $.ajax({
                ...
                success : function(data) {
                    if(data["code"] > 0 ){
                        ...
                        util.message( '该手机已经在团大人使用','danger');
                    }else{
                        util.message( data["message"],'danger');
                    }
                }
    ...
    $('#list').on('click', '.is_use', function(){
        ...
        util.alert($msg, function(){
            $.ajax({
                type : "post",
                url : "<?php echo __URL('PLATFORM_MAIN/auth/changeUserStatus'); ?>",
                async : true,
                data : {
