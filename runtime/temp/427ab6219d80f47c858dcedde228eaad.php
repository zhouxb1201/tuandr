<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:39:"template/platform/Member/growthNum.html";i:1591330110;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form action="" class="form-horizontal form-validate pt-15 widthFixedForm">
    <div class="form-group">
        ...
        <div class="col-md-5">
            ...
            <input type="number" class="form-control" id="complete_num" value="<?php echo $growth_info['complete_num']; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-md-5">
            <div class="input-group">
                <input type="number" id="recharge_money" class="form-control number-form-control"  value="<?php echo $growth_info['recharge_money']; ?>">
                <div class="input-group-addon">元，增加</div>
                <input type="number" id="recharge_num" class="form-control number-form-control"  value="<?php echo $growth_info['recharge_num']; ?>">
                <div class="input-group-addon">成长值</div>
                <div class="input-group-addon"> <input type="checkbox" id="recharge_multiple" name="recharge_multiple" <?php if($growth_info['recharge_multiple']==2): ?>checked<?php endif; ?> class="number-form-control">倍数递增</div>
            </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-5">
            <div class="input-group">
                <input type="number" id="order_money" class="form-control number-form-control"  value="<?php echo $growth_info['order_money']; ?>">
                <div class="input-group-addon">元，增加</div>
                <input type="number" id="pay_num" class="form-control number-form-control"  value="<?php echo $growth_info['pay_num']; ?>">
                <div class="input-group-addon">成长值</div>
                <div class="input-group-addon"> <input type="checkbox" id="order_multiple"  name="order_multiple" <?php if($growth_info['order_multiple']==2): ?>checked<?php endif; ?> class="number-form-control">倍数递增</div>
            </div>
...
require(['util'],function(util){
    util.validate($('.form-validate'),function(form){
            ...
            if(pay_num || complete_num || recharge_num){
                $.ajax({
                    type : "post",
                    url : "<?php echo __URL('PLATFORM_MAIN/Member/growthNum'); ?>",
                    async : false,
                    data : {
                        "pay_num" : pay_num,
                    ...
                    success : function(data) {
                        if (data["code"] > 0) {
                            util.message(data["message"],'success', "<?php echo __URL('PLATFORM_MAIN/Member/growthNum'); ?>");
                        }else{
