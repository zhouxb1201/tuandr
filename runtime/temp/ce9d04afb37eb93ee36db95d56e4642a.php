<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/www.tuandr.com/addons/fullcut/template/admin/addMansong.html";i:1583811694;}*/ ?>
        ...
        <div class="col-md-8">
            <div class="form-table-group" style="width: auto">
                <table class="table table-bordered table-auto-center table_rule">
                    ...
                    <tr class="rule_set">
                        <td>满<input type="number" id="price1" name="price" required class="form-control number-form-control-100 ml-15 mr-15" min="0" autocomplete="off">元</td>
                        <td>
                        <div>
                            <div class="form-group">
                    ...
                    <tr class="last-tr">
                        <td colspan="3" class="text-left">
                            <a href="javascript:;" class="text-primary addRule">增加一个规则</a> <span class="small-muted">最多增加五个</span>
                        </td>
                    </tr>
                </table>
            </div>
    ...
    require(['util'],function(util){
        ...
        $('.addRule').on('click',function(){
            ...
            if(obj.length>4){
                ...
                html +='<label class="col-md-3 control-label"><input class="discount_money" type="checkbox" id="discount'+nums+'" coupontype="reduce'+nums+'" name="discountChk"> 减金额</label>';
                ...
                html +='</div>';
                html +='<div class="form-group">';
                html +='<label class="col-md-3 control-label"><input name="free_shipping" id="free_shipping'+nums+'" type="checkbox" class=""> 免邮</label>';
                html +='</div>';
                //优惠券
        ...
        function LoadingInfo(page_index,range_type) {
            ...
            $.ajax({
                type : "post",
                url: "<?php echo __URL('admin/addons/execute/addons/fullcut/controller/fullcut/action/getserchgoodslist'); ?>",
                data : {
        ...
        util.validate($('.form-validate'),function(form){
            ...
            for(var i=0;i < obj.length;i++){
                ...
                //送礼品券
                var a = $("#giftvoucher"+num).is(':checked');
            ...
            $.ajax({
                type : "post",
                url : "<?php echo __URL('admin/Menu/addonmenu?addons=addFullCut'); ?>",
                data : {
                ...
                success : function(data) {
                    if (data["code"] > 0) {
                        util.message(data["message"],'success',"<?php echo __URL('admin/Menu/addonmenu?addons=fullCutList'); ?>");
                    }else{
