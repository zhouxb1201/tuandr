<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:33:"template/admin/Index/preview.html";i:1591320262;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<body style="background-color: #fff">
    ...
    <div class="preWrapper">
        <ul class="preTab">
            ...
            <li class="ml-93"><a href="<?php echo __URLS('ADDONS_SHOP_MAIN','addons=shopIndex&shop_id='.$instance_id); ?>" class="btn btn-primary" target="_blank">前往商城首页</a></li>
            <?php endif; ?>
        ...
        <div class="products">
                ...
                <div class="flex flex-pack-center preview_web">
                    ...
                    <div class="preview_web_right">
                        <div class="preview_web_right_qrbox">
                            ...
                            <div class="preview_code"><img src="<?php echo __URL('ADMIN_MAIN/index/getWapCode'); ?>" alt=""></div>
                        </div>
            ...
            <div class="main">
                <?php if($pcportStatus==1): ?>
                <iframe src="<?php echo __URLS('ADDONS_SHOP_MAIN','addons=shopIndex&shop_id='.$instance_id); ?>" width="100%" height="860" frameborder="0"></iframe>
                <?php endif; ?>
            </div>
        </div>
    </div>
