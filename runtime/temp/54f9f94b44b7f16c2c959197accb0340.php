<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"template/admin/System/freightTemplate.html";i:1583811758;s:24:"template/admin/base.html";i:1591103601;s:41:"template/admin/controlCommonVariable.html";i:1583811758;s:28:"template/admin/urlModel.html";i:1583811758;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="mb-20 flex flex-pack-justify">
    <div class="">
        <a href="<?php echo __URL('ADMIN_MAIN/express/freightTemplateEdit&co_id='.$co_id); ?>" class="btn btn-primary J-add"><i class="icon icon-add1"></i> 添加模板</a>
    </div>
...
<script>
  require(['utilAdmin'], function (utilAdmin) {
    ...
    function setDefaultShippingFee(shipping_fee_id) {
        ...
        $.ajax({
            url: "<?php echo __URL('ADMIN_MAIN/express/setDefaultShippingFee'); ?>",
            type: "POST",
            dataType: "JSON",
            data: {
                "co_id": co_id,
