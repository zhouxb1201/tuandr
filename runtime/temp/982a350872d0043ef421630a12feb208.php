<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/www/wwwroot/www.tuandr.com/addons/qlkefu/template/admin/qlkefuSetting.html";i:1583811694;}*/ ?>

        <!-- page -->
        <?php if(($info['seller_code'])): ?>
        ...
        <div class="form-horizontal pt-15">
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="switch-inline">
                        <input type="checkbox" name="is_use" id="is_use" <?php if($info['is_use']==1): ?>checked<?php endif; ?>>
            ...
            <div class="form-group">
				...
				<div class="col-md-5">
					<div class="input-group item">
						<input type="text" class="form-control item" name="domain" value="<?php echo $info['domain']; ?>" readonly="readonly">
						<span class="input-group-btn"><a href="javascript:void(0);" class="btn btn-default copy" data-clipboard-text="<?php echo $info['domain']; ?>">复制链接</a></span>
					</div>
			...
			<div class="form-group">
                ...
                <div class="col-md-5">
                    <input type="text" id="seller_code" class="form-control" name="seller_code" required value="<?php echo $info['seller_code']; ?>">
        ...
        <div class="form-horizontal pt-15">
            <div class="form-group">
				...
				<div class="col-md-5">
					<div class="input-group item">
						<input type="text" class="form-control item" name="seller_url" value="<?php echo $info['seller_url']; ?>" readonly="readonly">
						<span class="input-group-btn">
							<a href="javascript:void(0);" class="btn btn-default copy" data-clipboard-text="<?php echo $info['seller_url']; ?>">复制链接</a>
							<a href="<?php echo $info['seller_url']; ?>" class="btn btn-default" target="_blank">前往访问</a>
						</span>
					</div>
            ...
            <div class="form-group">
				...
				<div class="col-md-5">
					<div class="input-group item">
						<input type="text" class="form-control item" name="service_url" value="<?php echo $info['service_url']; ?>" readonly="readonly">
						<span class="input-group-btn">
							<a href="javascript:void(0);" class="btn btn-default copy" data-clipboard-text="<?php echo $info['service_url']; ?>">复制链接</a>
							<a href="<?php echo $info['service_url']; ?>" class="btn btn-default" target="_blank">前往访问</a>
						</span>
					</div>
		...
		<?php endif; if((empty($info['seller_code']))): ?>
  		<div class="realm_1 page1">
            <div class="domainName">客服系统须知</div>
            <ul class="domain-ul">
                <li>1、先前往<a href="<?php echo $info['seller_url']; ?>" class="text-primary" target="_blank"> 企聊客服 </a>注册账号。</li>
        ...
        <div class="page2" style="display: none">
            ...
            <form class="form-horizontal">
	            <div class="form-group">
					...
					<div class="col-md-5">
						<div class="input-group item">
							<input type="text" class="form-control item" value="<?php echo $info['seller_url']; ?>" readonly="readonly">
							<span class="input-group-btn">
								<a href="javascript:void(0);" class="btn btn-default copy" data-clipboard-text="<?php echo $info['seller_url']; ?>">复制链接</a>
								<a href="<?php echo $info['seller_url']; ?>" class="btn btn-default" target="_blank">前往访问</a>
							</span>
	            ...
	            <div class="form-group">
					...
					<div class="col-md-5">
						<div class="input-group item">
							<input type="text" class="form-control item" value="<?php echo $info['domain']; ?>" readonly="readonly">
							<span class="input-group-btn">
								<a href="javascript:void(0);" class="btn btn-default copy" data-clipboard-text="<?php echo $info['domain']; ?>">复制链接</a>
							</span>
						</div>
...
<script>
    require(['utilAdmin'],function(utilAdmin){
        ...
        utilAdmin.validate($('.form-validate2'), function (form) {
            ...
            $.ajax({
                type: "post",
                url:'<?php echo $addQlkefuUrl; ?>',
                data: data,
                success:function (data) {
                    if (data['code'] > 0) {
                        utilAdmin.message(data["message"], 'success',function(){
                        	window.location.href="<?php echo __URL('ADDONS_ADMIN_MAINqlkefuSetting'); ?>";
        				});
                    } else {
                        utilAdmin.message(data["message"], 'danger',function(){
                        	flag = false;
