<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:41:"template/platform/Goods/addGoodsSpec.html";i:1583811746;s:31:"template/platform/new_base.html";i:1587970146;s:44:"template/platform/controlCommonVariable.html";i:1583811744;s:31:"template/platform/urlModel.html";i:1583811744;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="col-md-5">
                    <div class="checkbox_three">
                        ...
                        <label class="checkbox-inline category-pr">
                            <input type="checkbox" name="attr_id" id="<?php echo $vo['attr_id']; ?>" value="<?php echo $vo['attr_id']; ?>"><?php echo $vo['attr_name']; ?>
                            <div class="category-pos">
                                <div class="category-arrow">
                                    <p>对应分类：</p>
        ...
        util.validate($('.form-validate'),function(form) {
            ...
            $.ajax({
                ...
                success : function(data) {
                    if (data["code"] > 0) {
                        util.message('添加成功', "success","<?php echo __URL('PLATFORM_MAIN/goods/goodsspeclist'); ?>");
                    } else {
