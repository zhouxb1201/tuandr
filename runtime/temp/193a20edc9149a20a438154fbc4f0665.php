<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:48:"template/platform/Goods/updateGoodsCategory.html";i:1591330109;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <?php endif; ?>
                ...
                <form class="form-horizontal pt-15 form-validate widthFixedForm">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="short_name" name="short_name" value="<?php echo $data['short_name']; ?>" autocomplete="off" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="category_name" name="category_name" value="<?php echo $data['category_name']; ?>" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <select class="form-control" id="pid">
                                ...
                                <?php if(is_array($category_list) || $category_list instanceof \think\Collection || $category_list instanceof \think\Paginator): if( count($category_list)==0 ) : echo "" ;else: foreach($category_list as $key=>$v1): if($v1['category_id']!=$category_id): ?>
                                <option value="<?php echo $v1['category_id']; ?>" data-pid="<?php echo $v1['pid']; ?>" data-attr_id="<?php echo $v1['attr_id']; ?>" <?php if($data['pid'] == $v1['category_id']): ?>selected<?php endif; ?>><?php echo $v1['short_name']; ?></option>
                                <?php endif; if(is_array($v1['child_list']) || $v1['child_list'] instanceof \think\Collection || $v1['child_list'] instanceof \think\Paginator): if( count($v1['child_list'])==0 ) : echo "" ;else: foreach($v1['child_list'] as $key=>$v2): if($v2['category_id']!=$category_id): ?>
                                <option value="<?php echo $v2['category_id']; ?>" data-pid="<?php echo $v2['pid']; ?>" data-attr_id="<?php echo $v2['attr_id']; ?>" <?php if($data['pid'] == $v2['category_id']): ?>selected<?php endif; ?>>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $v2['short_name']; ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div class="switch-inline">
                                <input type="checkbox" id="is_visible" <?php if($data['is_visible'] == 1): ?>checked="checked"<?php endif; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="sort" name="sort" min="0" value="<?php echo $data['sort']; ?>">
                            <p class="help-block mb-0">分类排序，数字越大越靠前。</p>
                        </div>
                    </div>
                    <div class="form-group J-img" <?php if($data['level'] < 3): ?> style="display:none;" <?php endif; ?>>
                        <label class="col-md-2 control-label">分类图片</label>
                        <div class="col-md-5">
                            <div class="picture-list" id="pictureList">
                                <?php if($data['category_pic']): ?>
                                <a href="javascript:void(0);" class="close-box"><i class="icon icon-danger" title="删除"></i><img src="<?php echo $data['category_pic']; ?>"></a>
                                <?php else: ?>
...
require(['util'],function(util){
    ...
    util.validate($('.form-validate'),function(form) {
        ...
        $.ajax({
            type : "post",
            url : "<?php echo __URL('PLATFORM_MAIN/goods/updategoodscategory'); ?>",
            data : {
