<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:37:"template/platform/Wchat/fansList.html";i:1591330114;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <?php endif; ?>
                ...
                <div class="flex-auto-center mb-20 bg-info text-center border-info">
                    <div class="flex-1 padding-15">
                        ...
                        <p id="fans_count"><?php echo $fans_count; ?></p>
...
require(['util'],function(util){
    ...
    function getList(page_index){
        ...
        $.ajax({
            type : "post",
            url : "<?php echo __URL('PLATFORM_MAIN/wchat/fansList'); ?>",
            async : true,
            data : {
    ...
    $('body').on('click','.check_group',function(){
            ...
            $.ajax({
                    type : "post",
                    url : "<?php echo __URL('PLATFORM_MAIN/Wchat/updateFansGroup'); ?>",
                    async : true,
                    data : {
                        "group_id" : group_id,
