<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"template/platform/Goods/goodsSpecList.html";i:1591330108;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<?php endif; ?>
    ...
    <div class="v-main">
        ...
        <!-- page -->
        <div class="mb-20">
            <a href="<?php echo __URL('PLATFORM_MAIN/Goods/addGoodsSpec'); ?>" class="btn btn-primary"><i class="icon icon-add1"></i> 添加规格</a>
        </div>
...
require(['util'],function(util){
    ...
    function LoadingInfo(pageIndex) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo __URL('PLATFORM_MAIN/goods/goodsspeclist'); ?>",
            async: true,
            data: {
    ...
    $('#specList').on('click','.delete_brand', function (id) {
        ...
        util.alert('确认删除此规格吗 ？', function () {
            $.ajax({
                type: "post",
                url: "<?php echo __URL('PLATFORM_MAIN/goods/deletegoodsspec'); ?>",
                data: {
    ...
    $('#specList').on('click', '.is_show', function(){
        ...
        // util.alert($msg, function () {
            $.ajax({
                type: "post",
                url: "<?php echo __URL('PLATFORM_MAIN/goods/updateGoodsspecShow'); ?>",
                data: {
    ...
    $("body").on('change', '.sort-form-control', function(){
        ...
        $.ajax({
            type : "post",
            url : "<?php echo __URL('PLATFORM_MAIN/Goods/setgoodsspecfield'); ?>",
            async : true,
