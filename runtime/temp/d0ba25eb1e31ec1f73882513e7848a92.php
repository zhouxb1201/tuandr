<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:47:"template/platform/Member/updateMemberLabel.html";i:1583811746;s:31:"template/platform/new_base.html";i:1587970146;s:44:"template/platform/controlCommonVariable.html";i:1583811744;s:31:"template/platform/urlModel.html";i:1583811744;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="v-container">
			...
			<form class="form-horizontal form-validate pt-15">
				<div class="form-group">
					...
					<div class="col-md-5">
						<input type="text" class="form-control" name="group_name" required value="<?php if($list['group_name']): ?><?php echo $list['group_name']; endif; ?>">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-5">
						<div class="switch-inline">
							<input type="checkbox" id="upgrade-switch" value="1" name="is_label" <?php if($list['is_label'] == 1): ?>checked<?php endif; ?>>
							<label for="upgrade-switch"></label>
						</div>
					</div>
				</div>
				<div id="isupgrade" class="<?php if($list['is_label'] != 1): ?>hide<?php endif; ?>">
					<div class="form-group">
						<label class="col-md-2 control-label">标签条件</label>
						<div class="col-md-5">
							<div>
							<label class="radio-inline">
								<input type="radio" value="1" name="upgradecondition" <?php if($list['label_condition'] == 1): ?>checked<?php endif; ?> > 满足所有勾选条件
							</label>
							<label class="radio-inline">
								<input type="radio" value="2" name="upgradecondition" <?php if($list['label_condition'] == 2): ?>checked<?php endif; ?>> 满足勾选条件之一即可
							</label>
								</div>
						</div>
					</div>
					<div class="form-group" id="upgrade-condition">
						...
						<div class="col-md-8">
							<div class="form-additional">
								<div class="form-group">
									<label class="col-md-5 control-label"><input type="checkbox" name="upgradeconditions" value="1"> 累积交易金额</label>
								...
								<div class="form-group">
									<label class="col-md-5 control-label"><input type="checkbox" name="upgradeconditions" value="2"> 累积支付订单</label>
									<div class="col-md-7 control-group">
										<div class="input-group">
											<input type="number" class="form-control" min="0" name="order_pay" value="<?php if($list['order_pay']): ?><?php echo $list['order_pay']; endif; ?>">
											<div class="input-group-addon">笔</div>
										</div>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-5 control-label"><input type="checkbox" name="upgradeconditions" value="3"> 当前积分大于</label>
									<div class="col-md-7 control-group">
										<div class="input-group">
											<input type="number" class="form-control" min="0" name="point" value="<?php if($list['point']): ?><?php echo $list['point']; endif; ?>">
											<div class="input-group-addon">积分</div>
										</div>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-5 control-label"><input type="checkbox" name="upgradeconditions" value="4"> 当前余额大于</label>
									<div class="col-md-7 control-group">
										<div class="input-group">
											<input type="number" class="form-control" min="0" name="balance" value="<?php if($list['balance']): ?><?php echo $list['balance']; endif; ?>">
											<div class="input-group-addon">元</div>
										</div>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-5 control-label"><input type="checkbox" name="upgradeconditions" value="5"> 购买指定商品</label>
									<div class="col-md-7 control-group" >
...
<input type="hidden" id="group_id" value="<?php echo $list['group_id']; ?>">
<input type="hidden" id="default_group_name" value="<?php echo $list['group_name']; ?>">
			<!-- page end -->
...
<script>
    require(['util'],function(util) {
        $("input[name='group_name']").on('blur',function () {
            ...
            var default_group_name = $("#default_group_name").val();
            if(default_group_name!=group_name ){
                $.ajax({
                    type : "post",
                    url : "<?php echo __URL('PLATFORM_MAIN/Member/checkLabel'); ?>",
                    async : true,
                    data : {
        ...
        loading();
        function loading() {
            var upgradeconditions = "<?php echo $list['labelconditions']; ?>";
        ...
        util.validate($('.form-validate'),function(form){
            ...
            $.ajax({
                type: "post",
                url: "<?php echo __URL('PLATFORM_MAIN/member/updateLabel'); ?>",
                data: {
                ...
                success: function (data) {
                    if (data['code'] > 0) {
                        util.message(data["message"], 'success', "<?php echo __URL('PLATFORM_MAIN/member/memberGroupList'); ?>");
                    } else {
