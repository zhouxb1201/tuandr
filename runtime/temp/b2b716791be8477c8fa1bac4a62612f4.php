<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/www/wwwroot/www.tuandr.com/addons/shop/template/platform/shopApplyList.html";i:1583811692;}*/ ?>
                    ...
                    if (data["data"].length > 0) {
                        for (var i = 0; i < data["data"].length; i++) {
                            ...
                            if (data["data"][i]['apply_state'] === '1') {
                                html += '<td><span class="label label-danger">待审核</span></td>';
                            } else if (data["data"][i]['apply_state'] === '2') {
                                html += '<td><span class="label label-success">审核通过</span></td>';
                            } else if (data["data"][i]['apply_state'] === '-1') {
                                html += '<td><span class="label label-danger">审核失败</span></td>';
                            }
