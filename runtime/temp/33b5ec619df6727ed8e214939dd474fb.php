<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/www/wwwroot/www.tuandr.com/addons/store/template/platform/addAssistant.html";i:1583811702;}*/ ?>
                ...
                success: function (data) {
                    if (data["code"] > 0) {
                        util.message(data["message"], 'success', function () {
                            window.location.href = "<?php echo __URL('ADDONS_MAINassistantList'); ?>";
                        });
                    } else {
