<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"template/platform/Shop/linksMinDialog.html";i:1591330113;}*/ ?>
    ...
    <div class="tab-content min-h-200">
        <div role="tabpanel" class="tab-pane fade in active" id="mall">
            ...
            <div class="" id="custom">
                ...
                <!--  platform端为了区分自营和全平台，当type=2店铺首页就带上shop_id=0 用自营店，否则其他链接都用全平台    -->
                <?php if($type == '2'): ?>
                ...
                <a href="javascript:void(0);" class="btn btn-default selectedPage" data-link="package/pages/signin/index/index">签到中心</a>
                ...
                <a href="javascript:void(0);" class="btn btn-default selectedPage" data-link="packageSecond/pages/credential/code/index">授权证书</a>
                <a href="javascript:void(0);" class="btn btn-default selectedPage" data-link="packageSecond/pages/credential/search/index">查询证书</a>
                ...
                <a href="javascript:void(0);" class="btn btn-default selectedPage" data-link="packageSecond/pages/anticounterfeiting/search/index">防伪溯源</a>
