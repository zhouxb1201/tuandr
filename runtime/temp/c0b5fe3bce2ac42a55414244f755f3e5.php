<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:40:"template/platform/Goods/updateGoods.html";i:1591330109;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<ul class="nav nav-tabs v-nav-tabs add_tab1" role="tablist">
    ...
    <?php endif; if($goods_info['goods_type']): ?>
    <li role="presentation"><a href="#goods_attribute" aria-controls="goods_attribute" role="tab" data-toggle="tab" class="flex-auto-center <?php if(($goods_info['goods_type']==4)): ?>hide<?php endif; ?>">规格/属性</a></li>
    <?php endif; ?>
    ...
    <?php endif; if(($goods_info['goods_type']==0)): ?>
...
<form class="form-horizontal form-validate widthFixedForm">
    <input type="hidden" id="goodsId" name="a" value="<?php echo $goods_id; ?>" />
    ...
    <div id="myTabContent" class="tab-content">
        ...
        <div class="tab-pane fade tab-1 active in" id="goods_info">
            ...
            <ul class="mb-20 type-select-radio clearfix goods-ts-radio">
                ...
                <li class="goodType4 active">
                    <div class="radio-label-div">
                        ...
                        <!--<img src="/public/platform/images/goodType7.png" alt="" class="">-->
                    </div>
                    <span class="icon-success-sel"><img src="/public/platform/images/goodTypeSel.png" alt=""></span>
                </li>
                <?php else: if($store == '1'): if($goods_info['goods_type'] == 0): ?>
                <li class="goodType2 active">
                    <div class="radio-label-div">
                        <div class="">
                            <div>计时/次商品</div>
                            <p class="p1">(线下消费核销码)</p>
                        </div>
                        <!--<img src="/public/platform/images/goodType2.png" alt="" class="">-->
                    </div>
                    <span class="icon-success-sel"><img src="/public/platform/images/goodTypeSel.png" alt=""></span>
                </li>
            ...
            <div class="form-group">
                ...
                <input type="hidden" id="category" name="a" value="<?php echo $goods_info['category_id']; ?>">
                <div class="col-md-5">
                ...
                <div class="col-sm-8" id="tbcNameCategory" data-flag="category" cid="<?php echo $goods_info['category_id']; ?>" data-attr-id="<?php echo $goods_info['goods_attribute_id']; ?>" cname="<?php echo $goods_info['category_name']; ?>" data-goods-id="<?php echo $goodsid; ?>">
                <input type="hidden" id="category_id_1" name="category_id_1" value="<?php echo $goods_info['category_id_1']; ?>">
                <input type="hidden" id="category_id_2" name="category_id_2" value="<?php echo $goods_info['category_id_2']; ?>">
                <input type="hidden" id="category_id_3" name="category_id_3" value="<?php echo $goods_info['category_id_3']; ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" name="title" id="txtProductTitle" required value="<?php echo $goods_info['goods_name']; ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <div class="input-group w-200">
                        <input type="number" class="form-control promotion_type" min="0" step="0.01" name="txtProductSalePrice" id="txtProductSalePrice" value="<?php echo $goods_info['price']; ?>" required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <div class="input-group w-200">
                        <input type="number" class="form-control promotion_type" min="0" step="0.01" name="txtProductMarketPrice" id="txtProductMarketPrice" value="<?php echo $goods_info['market_price']; ?>">
                        <span class="input-group-addon">元</span>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <div class="input-group w-200">
                        <input type="number" class="form-control promotion_type" min="0" step="0.01" name="txtProductCostPrice" id="txtProductCostPrice" value="<?php echo $goods_info['cost_price']; ?>">
                        <span class="input-group-addon">元</span>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <div class="input-group w-200">
                        <input type="number" class="form-control promotion_type" min="0" name="txtProductCount" id="txtProductCount" value="<?php echo $goods_info['stock']; ?>" required>
            ...
            <div class="fold-field">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="txtProductCodeA" id="txtProductCodeA" value="<?php echo $goods_info['code']; ?>" autocomplete="off" notChinese="true">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">商品货号</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="item_no" id="item_no" value="<?php echo $goods_info['item_no']; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="number" class="form-control w-200" min="0" name="sort" id="goodsSort" value="<?php echo $goods_info['sort']; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="input-group w-200">
                            ...
                            <input type="number" class="form-control" min="0" name="txtMinStockLaram" id="txtMinStockLaram" value="<?php echo $goods_info['min_stock_alarm']; ?>">
                            <span class="input-group-addon">件</span>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <div class="checkbox_three">
                            <label class="checkbox-inline"><input type="checkbox" name="goods_labels" id="is_recommend" <?php if($goods_info['is_recommend'] == 1): ?>checked<?php endif; ?>>推荐</label>
                            <label class="checkbox-inline"><input type="checkbox" name="goods_labels" id="is_new" <?php if($goods_info['is_new'] == 1): ?>checked<?php endif; ?>>新品</label>
                            <label class="checkbox-inline"><input type="checkbox" name="goods_labels" id="is_hot" <?php if($goods_info['is_hot'] == 1): ?>checked<?php endif; ?>>热卖</label>
                            <label class="checkbox-inline"><input type="checkbox" name="goods_labels" id="is_promotion" <?php if($goods_info['is_promotion'] == 1): ?>checked<?php endif; ?>>促销</label>
                            <label class="checkbox-inline"><input type="checkbox" name="goods_labels" id="is_shipping_free" <?php if($goods_info['is_shipping_free'] == 1): ?>checked<?php endif; ?>>包邮</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" class="visibility" id="visibility1" name="picture" data-visi-type="multiPicture">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <div class="picture-list" id="pc_video_adv">
                        ...
                        <input type="hidden" name="upload_video_id" value="<?php echo $goods_info['video_id']; ?>" />
                        <?php else: ?>
            ...
            <!-- 图片 end -->
            <div class="screen-title2 <?php if(($goods_info['goods_type']!=1)): ?>hide<?php endif; ?>" data-id="t7" >
                <span class="text" id="shipping_fee_title">物流/其他</span>
            </div>
            <div class="isgoods_type_1 <?php if(($goods_info['goods_type']!=1)): ?>hide<?php endif; ?>" id="shipping_fee_data">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="radio">
                            ...
                            <div class="inline-block ml-10 w15">
                                <input type="number" class="form-control number-form-control w-200" id="shipping_fee" value="<?php echo $goods_info['shipping_fee']; ?>" name="shipping_fee" min="0" placeholder="￥" <?php if($goods_info['shipping_fee_type']  != 1): ?> disabled <?php endif; ?> data-visi-type="prices_1" <?php if($goods_info['shipping_fee_type']  == 1): ?> required <?php endif; ?>>
                            </div>
                        </div>
                        <div class="radio">
                            <label>
                            ...
                            <div class="inline-block ml-10">
                                <select min="0" class="form-control select-form-control" id="shipping_fee_id" name="shipping_fee_id" <?php if($goods_info['shipping_fee_type']  != 2): ?> disabled <?php endif; if($goods_info['shipping_fee_type']  == 2): ?> required <?php endif; ?>>
                                    ...
                                    <option value="<?php echo $vo['shipping_fee_id']; ?>" type="<?php echo $vo['calculate_type']; ?>" <?php if($goods_info['shipping_fee_id'] == $vo['shipping_fee_id']): ?>selected="selected"<?php endif; ?>><?php echo $vo['shipping_fee_name']; if($vo['is_default'] == 1): ?>【默认】 <?php endif; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                            <div class="help-block mb-0"> 没有运费模板？去<a href="<?php echo __URL('PLATFORM_MAIN/express/freighttemplatelist'); ?>" target="_blank" class="text-primary">新建</a>，新建完点 <a href="javascript:void(0);" class="text-primary J-refresh" data-shipping="<?php echo $goods_info['shipping_fee_id']; ?>">刷新</a>  重新加载数据</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <div class="radio">
                        <label>
                            <input type="radio" name="state" value="1" <?php if($goods_info['state'] == 1): ?>checked<?php endif; ?>> 立即上架
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="state" value="0" <?php if($goods_info['state'] == 0): ?>checked<?php endif; ?>> 放入仓库
                        </label>
                    </div>
                </div>
            </div><!-- 物流/其他 end -->
                ...
                <div id="isgoods_attribute" class="hidden">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <table class="table table-bordered table-auto-center v-table" id="stock_table">
                                <thead></thead>
                                <tbody></tbody>
                                <tfoot>
                                    <tr>
        ...
        <div class="tab-pane fade tab-4" id="distribution_bonus">
            ...
            <div class="form-group distribution_rules <?php if($goods_info['is_distribution']): if($goods_info['is_distribution']==2): ?>hide<?php endif; endif; ?>">
                ...
                <div class="col-md-8" >
                    ...
                    <div class="switch-inline">
                        <input type="checkbox" name="distribution_rule" id="distribution_rule" <?php if($goods_info['distribution_rule']): if($goods_info['distribution_rule']==1): ?>checked<?php endif; endif; ?>>
            ...
            <div class="form-group <?php if($goods_info['is_distribution']==1 && $goods_info['distribution_rule'] && $goods_info['distribution_rule']==1): else: ?>hide<?php endif; ?>" id="level_rules">
            ...
            <div class="form-group <?php if($goods_info['is_distribution']==1 && $goods_info['distribution_rule'] && $goods_info['distribution_rule']==1): else: ?>hide<?php endif; ?>" id="recommend_type">
                <label class="col-md-2 control-label">返佣类型</label>
                <div class="col-md-8" >
                    <label class="radio-inline">
                        <input type="radio" name="recommend_type" class="recommend_type" <?php if($goods_info['distribution_rule_val'] && $goods_info['distribution_rule_val']['recommend_type'] && $goods_info['distribution_rule_val']['recommend_type']==1): ?>checked<?php endif; ?> value="1"> 比例返佣
                    </label>
                    <label class="radio-inline">
            ...
            <div class="form-group <?php if($goods_info['is_distribution']==1 && $goods_info['distribution_rule'] && $goods_info['distribution_rule']==1  && $goods_info['distribution_rule_val'] && $goods_info['distribution_rule_val']['recommend_type'] && $goods_info['distribution_rule_val']['recommend_type']==1 && $goods_info['distribution_rule_val']['level_rule'] && $goods_info['distribution_rule_val']['level_rule']==2): else: ?>hide<?php endif; ?>" id="distribution_input">
            ...
            <!-- 复购设置 -->
            <div class="c <?php if($goods_info['is_distribution']): if($goods_info['is_distribution']==2): ?>hide<?php endif; endif; ?>" id="buyagain_rules">
                <div class="form-group " >
                    <label class="col-md-2 control-label">复购返佣</label>
                    <div class="col-md-5">
                        <div class="switch-inline">
                            <input type="checkbox" id="buyagain-switch" value="1" name="buyagain" <?php if($goods_info['buyagain']): if($goods_info['buyagain']==1): ?>checked<?php endif; endif; ?>>
                            <label for="buyagain-switch"></label>
                        </div>
                        <div class="mb-0 help-block">开启后分销商下线再次购买商城商品时则按照复购返佣规则计算佣金</div>
                    </div>
                </div>
                <div class="buyagain_commission <?php if($goods_info['is_distribution']==1 && $goods_info['buyagain'] && $goods_info['buyagain']==1): else: ?>hide<?php endif; ?> " >
                    <div class="form-group " id="buyagain_level_rules">
                        <label class="col-md-2 control-label">开启等级返佣</label>
                        <input type="hidden" id="buyagain_l_rule"  name="buyagain_l_rule">
                        <div class="col-md-8" >
                            <div class="switch-inline">
                                <input type="checkbox" name="buyagain_level_rule" id="buyagain_level_rule" <?php if($goods_info['buyagain_level_rule']): if($goods_info['buyagain_level_rule']==1): ?>checked<?php endif; endif; ?>>
                    ...
                    <div class="form-group " id="buyagain_recommend_type">
                        ...
                        <div class="col-md-8" >
                            <label class="radio-inline">
                                <input type="radio" name="buyagain_recommend_type" checked  class="buyagain_recommend_type" <?php if($goods_info['buyagain_recommend_type']): if($goods_info['buyagain_recommend_type']==1): ?>checked<?php endif; endif; ?> value="1"> 比例返佣
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="buyagain_recommend_type" class="buyagain_recommend_type" <?php if($goods_info['buyagain_recommend_type']): if($goods_info['buyagain_recommend_type']==2): ?>checked<?php endif; endif; ?> value="2"  > 固定返佣
                            </label>
                        </div>
                    </div>
                    
                    <div class="form-group <?php if($goods_info['buyagain']==1 && $goods_info['buyagain_distribution_val'] && $goods_info['buyagain_recommend_type'] && $goods_info['buyagain_recommend_type']==1 && $goods_info['buyagain_level_rule'] && $goods_info['buyagain_level_rule']==2): else: ?>hide<?php endif; ?>" id="buyagain_distribution_input">
                        <label class="col-md-2"></label>
                        <div class="col-md-5">
                            <div class="input-group">
                                <div class="input-group-addon">一级返佣</div>
                                <input type="number" name="buyagain_first_rebate" id="buyagain_first_rebate" class="form-control rebate" min="0"  style="min-width: 74px" value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['buyagain_first_rebate'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule']==2): if($goods_info['buyagain_distribution_val']['buyagain_first_rebate']): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_first_rebate']; else: ?>0<?php endif; else: ?>0<?php endif; ?>">
                                <div class="input-group-addon">%,二级返佣</div>
                                <input type="number" name="buyagain_second_rebate" id="buyagain_second_rebate" class="form-control rebate" min="0"   style="min-width: 74px" value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['buyagain_second_rebate'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule']==2): if($goods_info['buyagain_distribution_val']['buyagain_second_rebate']): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_second_rebate']; else: ?>0<?php endif; else: ?>0<?php endif; ?>">
                                <div class="input-group-addon">%,三级返佣</div>
                                <input type="number" name="buyagain_third_rebate" id="buyagain_third_rebate" class="form-control rebate" min="0" style="min-width: 74px" value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['buyagain_third_rebate'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule']==2): if($goods_info['buyagain_distribution_val']['buyagain_third_rebate']): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_third_rebate']; else: ?>0<?php endif; else: ?>0<?php endif; ?>">
                                <div class="input-group-addon">%</div>
                            </div>
                            <br>
                            <div class="input-group">
                                <div class="input-group-addon">一级返积分</div>
                                <input type="number" name="buyagain_first_point" id="buyagain_first_point" class="form-control rebate" min="0"  value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['buyagain_first_point'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule']==2): if($goods_info['buyagain_distribution_val']['buyagain_first_point']): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_first_point']; else: ?>0<?php endif; else: ?>0<?php endif; ?>"  style="min-width: 74px">
                                <div class="input-group-addon">%,二级返积分</div>
                                <input type="number" name="buyagain_second_point" id="buyagain_second_point" class="form-control rebate" min="0"   value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['buyagain_second_point'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule']==2): if($goods_info['buyagain_distribution_val']['buyagain_second_point']): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_second_point']; else: ?>0<?php endif; else: ?>0<?php endif; ?>" style="min-width: 74px">
                                <div class="input-group-addon">%,三级返积分</div>
                                <input type="number" name="buyagain_third_point" id="buyagain_third_point" class="form-control rebate" min="0" value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['buyagain_third_point'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule']==2): if($goods_info['buyagain_distribution_val']['buyagain_third_point']): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_third_point']; else: ?>0<?php endif; else: ?>0<?php endif; ?>" style="min-width: 74px">
                                <div class="input-group-addon">%</div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group <?php if($goods_info['buyagain']==1 && $goods_info['buyagain_distribution_val'] && $goods_info['buyagain_recommend_type'] && $goods_info['buyagain_recommend_type']==2 && $goods_info['buyagain_level_rule'] && $goods_info['buyagain_level_rule']==2): else: ?>hide<?php endif; ?>" id="buyagain_distribution_input1">
                        <label class="col-md-2"></label>
                        <div class="col-md-5">
                            <div class="input-group">
                                <div class="input-group-addon">一级返佣金</div>
                                <input type="number" name="buyagain_first_rebate1" id="buyagain_first_rebate1" class="form-control rebate" min="0"  value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['buyagain_first_rebate1'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule']==2): if($goods_info['buyagain_distribution_val']['buyagain_first_rebate1']): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_first_rebate1']; else: ?>0<?php endif; else: ?>0<?php endif; ?>"  style="min-width: 74px">
                                <div class="input-group-addon">元,二级返佣金</div>
                                <input type="number" name="buyagain_second_rebate1" id="buyagain_second_rebate1" class="form-control rebate" min="0"   value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['buyagain_second_rebate1'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule']==2): if($goods_info['buyagain_distribution_val']['buyagain_second_rebate1']): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_second_rebate1']; else: ?>0<?php endif; else: ?>0<?php endif; ?>" style="min-width: 74px">
                                <div class="input-group-addon">元,三级返佣金</div>
                                <input type="number" name="buyagain_third_rebate1" id="buyagain_third_rebate1" class="form-control rebate" min="0" value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['buyagain_third_rebate1'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule']==2): if($goods_info['buyagain_distribution_val']['buyagain_third_rebate1']): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_third_rebate1']; else: ?>0<?php endif; else: ?>0<?php endif; ?>" style="min-width: 74px">
                                <div class="input-group-addon">元</div>
                            </div>
                            <br>
                            <div class="input-group">
                                <div class="input-group-addon">一级返积分</div>
                                <input type="number" name="buyagain_first_point1" id="buyagain_first_point1" class="form-control rebate" min="0"  value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['buyagain_first_point1'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule']==2): if($goods_info['buyagain_distribution_val']['buyagain_first_point1']): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_first_point1']; else: ?>0<?php endif; else: ?>0<?php endif; ?>"  style="min-width: 74px">
                                <div class="input-group-addon">积分,二级返积分</div>
                                <input type="number" name="buyagain_second_point1" id="buyagain_second_point1" class="form-control rebate" min="0"   value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['buyagain_second_point1'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule']==2): if($goods_info['buyagain_distribution_val']['buyagain_second_point1']): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_second_point1']; else: ?>0<?php endif; else: ?>0<?php endif; ?>" style="min-width: 74px">
                                <div class="input-group-addon">积分,三级返积分</div>
                                <input type="number" name="buyagain_third_point1" id="buyagain_third_point1" class="form-control rebate" min="0" value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['buyagain_third_point1'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule'] && $goods_info['buyagain_distribution_val']['buyagain_level_rule']==2): if($goods_info['buyagain_distribution_val']['buyagain_third_point1']): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_third_point1']; else: ?>0<?php endif; else: ?>0<?php endif; ?>" style="min-width: 74px">
                                <div class="input-group-addon">积分</div>
                            </div>
                        </div>
                    </div>
                    <div class="<?php if($goods_info['buyagain']==1 && $goods_info['buyagain_distribution_val'] && $goods_info['buyagain_recommend_type'] && $goods_info['buyagain_recommend_type']==1 && $goods_info['buyagain_level_rule'] && $goods_info['buyagain_level_rule']==1): else: ?>hide<?php endif; ?>" id="buyagain_distribution_input2">
                        <?php if($level_list): foreach($level_list as $k=>$v): ?>
                        <div class="form-group">
                            <label class="col-md-2"></label>
                            <div class="col-md-5">
                                <div class="input-group">
                                    <div class="input-group-addon"><?php echo $v['level_name']; ?>一级返佣</div>
                                    <input type="number" name="buyagain_level_first_rebate_<?php echo $v['id']; ?>" id="buyagain_level_first_rebate_<?php echo $v['id']; ?>" class="form-control rebate" min="0"  value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['level_ids']): foreach($goods_info['buyagain_distribution_val']['level_ids'] as $k1=>$v1): if($v1==$v['id']): if($goods_info['buyagain_distribution_val']['buyagain_first_rebate'][$k1]): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_first_rebate'][$k1]; else: ?>0<?php endif; endif; endforeach; else: ?>0<?php endif; ?>"  style="min-width: 74px">
                                    <div class="input-group-addon">%,<?php echo $v['level_name']; ?>二级返佣</div>
                                    <input type="number" name="buyagain_level_second_rebate_<?php echo $v['id']; ?>" id="buyagain_level_second_rebate_<?php echo $v['id']; ?>" class="form-control rebate" min="0"   value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['level_ids']): foreach($goods_info['buyagain_distribution_val']['level_ids'] as $k1=>$v1): if($v1==$v['id']): if($goods_info['buyagain_distribution_val']['buyagain_second_rebate'][$k1]): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_second_rebate'][$k1]; else: ?>0<?php endif; endif; endforeach; else: ?>0<?php endif; ?>" style="min-width: 74px">
                                    <div class="input-group-addon">%,<?php echo $v['level_name']; ?>三级返佣</div>
                                    <input type="number" name="buyagain_level_third_rebate_<?php echo $v['id']; ?>" id="buyagain_level_third_rebate_<?php echo $v['id']; ?>" class="form-control rebate" min="0" value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['level_ids']): foreach($goods_info['buyagain_distribution_val']['level_ids'] as $k1=>$v1): if($v1==$v['id']): if($goods_info['buyagain_distribution_val']['buyagain_third_rebate'][$k1]): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_third_rebate'][$k1]; else: ?>0<?php endif; endif; endforeach; else: ?>0<?php endif; ?>" style="min-width: 74px">
                                    <div class="input-group-addon">%</div>
                                </div>
                                <br>
                                <div class="input-group">
                                    <div class="input-group-addon"><?php echo $v['level_name']; ?>一级返积分</div>
                                    <input type="number" name="buyagain_level_first_point_<?php echo $v['id']; ?>" id="buyagain_level_first_point_<?php echo $v['id']; ?>" class="form-control rebate" min="0"  value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['level_ids']): foreach($goods_info['buyagain_distribution_val']['level_ids'] as $k1=>$v1): if($v1==$v['id']): if($goods_info['buyagain_distribution_val']['buyagain_first_point'][$k1]): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_first_point'][$k1]; else: ?>0<?php endif; endif; endforeach; else: ?>0<?php endif; ?>"  style="min-width: 74px">
                                    <div class="input-group-addon">%,<?php echo $v['level_name']; ?>二级返积分</div>
                                    <input type="number" name="buyagain_level_second_point_<?php echo $v['id']; ?>" id="buyagain_level_second_point_<?php echo $v['id']; ?>" class="form-control rebate" min="0"   value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['level_ids']): foreach($goods_info['buyagain_distribution_val']['level_ids'] as $k1=>$v1): if($v1==$v['id']): if($goods_info['buyagain_distribution_val']['buyagain_second_point'][$k1]): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_second_point'][$k1]; else: ?>0<?php endif; endif; endforeach; else: ?>0<?php endif; ?>" style="min-width: 74px">
                                    <div class="input-group-addon">%,<?php echo $v['level_name']; ?>三级返积分</div>
                                    <input type="number" name="buyagain_level_third_point_<?php echo $v['id']; ?>" id="buyagain_level_third_point_<?php echo $v['id']; ?>" class="form-control rebate" min="0" value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['level_ids']): foreach($goods_info['buyagain_distribution_val']['level_ids'] as $k1=>$v1): if($v1==$v['id']): if($goods_info['buyagain_distribution_val']['buyagain_third_point'][$k1]): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_third_point'][$k1]; else: ?>0<?php endif; endif; endforeach; else: ?>0<?php endif; ?>" style="min-width: 74px">
                                    <div class="input-group-addon">%</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="<?php if($goods_info['buyagain']==1 && $goods_info['buyagain_distribution_val'] && $goods_info['buyagain_recommend_type'] && $goods_info['buyagain_recommend_type']==2 && $goods_info['buyagain_level_rule'] && $goods_info['buyagain_level_rule']==1): else: ?>hide<?php endif; ?>" id="buyagain_distribution_input3">
                        <?php if($level_list): foreach($level_list as $k=>$v): ?>
                        <div class="form-group">
                            <label class="col-md-2"></label>
                            <div class="col-md-5">
                                <div class="input-group">
                                    <div class="input-group-addon"><?php echo $v['level_name']; ?>一级返佣金</div>
                                    <input type="number" name="buyagain_level_first_rebate1_<?php echo $v['id']; ?>" id="buyagain_level_first_rebate1_<?php echo $v['id']; ?>" class="form-control rebate" min="0"  value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['level_ids']): foreach($goods_info['buyagain_distribution_val']['level_ids'] as $k1=>$v1): if($v1==$v['id']): if($goods_info['buyagain_distribution_val']['buyagain_first_rebate1'][$k1]): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_first_rebate1'][$k1]; else: ?>0<?php endif; endif; endforeach; else: ?>0<?php endif; ?>"  style="min-width: 74px">
                                    <div class="input-group-addon">元,<?php echo $v['level_name']; ?>二级返佣金</div>
                                    <input type="number" name="buyagain_level_second_rebate1_<?php echo $v['id']; ?>" id="buyagain_level_second_rebate1_<?php echo $v['id']; ?>" class="form-control rebate" min="0"   value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['level_ids']): foreach($goods_info['buyagain_distribution_val']['level_ids'] as $k1=>$v1): if($v1==$v['id']): if($goods_info['buyagain_distribution_val']['buyagain_second_rebate1'][$k1]): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_second_rebate1'][$k1]; else: ?>0<?php endif; endif; endforeach; else: ?>0<?php endif; ?>" style="min-width: 74px">
                                    <div class="input-group-addon">元,<?php echo $v['level_name']; ?>三级返佣金</div>
                                    <input type="number" name="buyagain_level_third_rebate1_<?php echo $v['id']; ?>" id="buyagain_level_third_rebate1_<?php echo $v['id']; ?>" class="form-control rebate" min="0" value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['level_ids']): foreach($goods_info['buyagain_distribution_val']['level_ids'] as $k1=>$v1): if($v1==$v['id']): if($goods_info['buyagain_distribution_val']['buyagain_third_rebate1'][$k1]): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_third_rebate1'][$k1]; else: ?>0<?php endif; endif; endforeach; else: ?>0<?php endif; ?>" style="min-width: 74px">
                                    <div class="input-group-addon">元</div>
                                </div>
                                <br>
                                <div class="input-group">
                                    <div class="input-group-addon"><?php echo $v['level_name']; ?>一级返积分</div>
                                    <input type="number" name="buyagain_level_first_point1_<?php echo $v['id']; ?>" id="buyagain_level_first_point1_<?php echo $v['id']; ?>" class="form-control rebate" min="0"  value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['level_ids']): foreach($goods_info['buyagain_distribution_val']['level_ids'] as $k1=>$v1): if($v1==$v['id']): if($goods_info['buyagain_distribution_val']['buyagain_first_point1'][$k1]): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_first_point1'][$k1]; else: ?>0<?php endif; endif; endforeach; else: ?>0<?php endif; ?>"  style="min-width: 74px">
                                    <div class="input-group-addon">积分,<?php echo $v['level_name']; ?>二级返积分</div>
                                    <input type="number" name="buyagain_level_second_point1_<?php echo $v['id']; ?>" id="buyagain_level_second_point1_<?php echo $v['id']; ?>" class="form-control rebate" min="0"   value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['level_ids']): foreach($goods_info['buyagain_distribution_val']['level_ids'] as $k1=>$v1): if($v1==$v['id']): if($goods_info['buyagain_distribution_val']['buyagain_second_point1'][$k1]): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_second_point1'][$k1]; else: ?>0<?php endif; endif; endforeach; else: ?>0<?php endif; ?>" style="min-width: 74px">
                                    <div class="input-group-addon">积分,<?php echo $v['level_name']; ?>三级返积分</div>
                                    <input type="number" name="buyagain_level_third_point1_<?php echo $v['id']; ?>" id="buyagain_level_third_point1_<?php echo $v['id']; ?>" class="form-control rebate" min="0" value="<?php if($goods_info['buyagain_distribution_val'] && $goods_info['buyagain_distribution_val']['level_ids']): foreach($goods_info['buyagain_distribution_val']['level_ids'] as $k1=>$v1): if($v1==$v['id']): if($goods_info['buyagain_distribution_val']['buyagain_third_point1'][$k1]): ?><?php echo $goods_info['buyagain_distribution_val']['buyagain_third_point1'][$k1]; else: ?>0<?php endif; endif; endforeach; else: ?>0<?php endif; ?>" style="min-width: 74px">
                                    <div class="input-group-addon">积分</div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8" >
                    <label class="radio-inline">
                        <input type="radio" name="is_bonus_global" class="is_bonus_global"  value="1" <?php if($goods_info['is_bonus_global']): if($goods_info['is_bonus_global']==1): ?>checked<?php endif; endif; ?>> 参与
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="is_bonus_global" class="is_bonus_global" value="2" <?php if($goods_info['is_bonus_global']): if($goods_info['is_bonus_global']==2): ?>checked<?php endif; else: ?>checked<?php endif; ?>> 不参与
                    </label>
                    <div class="mb-0 help-block">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8" >
                    <label class="radio-inline">
                        <input type="radio" name="is_bonus_area" class="is_bonus_area"  value="1" <?php if($goods_info['is_bonus_area']): if($goods_info['is_bonus_area']==1): ?>checked<?php endif; endif; ?>> 参与
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="is_bonus_area" class="is_bonus_area" value="2" <?php if($goods_info['is_bonus_area']): if($goods_info['is_bonus_area']==2): ?>checked<?php endif; else: ?>checked<?php endif; ?>> 不参与
                    </label>
                    <div class="mb-0 help-block">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8" >
                    <label class="radio-inline">
                        <input type="radio" name="is_bonus_team" class="is_bonus_team"  value="1" <?php if($goods_info['is_bonus_team']): if($goods_info['is_bonus_team']==1): ?>checked<?php endif; endif; ?>> 参与
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="is_bonus_team" class="is_bonus_team" value="2" <?php if($goods_info['is_bonus_team']): if($goods_info['is_bonus_team']==2): ?>checked<?php endif; else: ?>checked<?php endif; ?>> 不参与
                    </label>
                    <div class="mb-0 help-block">
            ...
            <?php endif; ?>
            <div class="form-group <?php if($goods_info['is_bonus_global'] && $goods_info['is_bonus_global']==2 && $goods_info['is_bonus_area'] && $goods_info['is_bonus_area']==2 && $goods_info['is_bonus_team'] && $goods_info['is_bonus_team']==2): ?>hide<?php endif; ?>" id="bounsRules">
                ...
                <div class="col-md-8" >
                    <div class="switch-inline">
                        <input type="checkbox" name="bonus_rule" id="bonus_rule" <?php if($goods_info['bonus_rule']): if($goods_info['bonus_rule']==1): ?>checked<?php endif; endif; ?>>
            ...
            <div class="form-group <?php if($goods_info['bonus_rule']): if($goods_info['bonus_rule']!=1): ?>hide<?php endif; else: ?>hide<?php endif; ?>" id="bonus_input">
                <label class="col-md-2"></label>
                <div class="col-md-8">
                    <table class="table v-table table-auto-center table-bordered">
                        <thead>
                            <tr>
                                <?php if($globalExist==1): ?>
                                <th class="w-200 bonus-td1 <?php if($goods_info['is_bonus_global']): if($goods_info['is_bonus_global']==2): ?>hide<?php endif; endif; ?>">全球分红</th>
                                <?php endif; if($areaExist==1): ?>
                                <th class="w-600 bonus-td2 <?php if($goods_info['is_bonus_area']): if($goods_info['is_bonus_area']==2): ?>hide<?php endif; endif; ?>">区域分红</th>
                                <?php endif; if($teamExist==1): ?>
                                <th class="w-200 bonus-td3 <?php if($goods_info['is_bonus_team']): if($goods_info['is_bonus_team']==2): ?>hide<?php endif; endif; ?>">团队分红</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <?php if($globalExist==1): ?>
                                <td class="bonus-td1 <?php if($goods_info['is_bonus_global']): if($goods_info['is_bonus_global']==2): ?>hide<?php endif; endif; ?>">
                                    <div class="input-group">
                                        <input style="min-width: 74px" type="number"  name="global_bonus" id="global_bonus" class="form-control global_bonus" min="0"  value="<?php if($goods_info['bonus_rule_val'] && $goods_info['bonus_rule_val']['global_bonus']): ?><?php echo $goods_info['bonus_rule_val']['global_bonus']; endif; ?>">
                                        <div class="input-group-addon">%</div>
                                    </div>
                                </td>
                                <?php endif; if($areaExist==1): ?>
                                <td class="bonus-td2 <?php if($goods_info['is_bonus_area']): if($goods_info['is_bonus_area']==2): ?>hide<?php endif; endif; ?>">
                                    <div class="input-group">
                                        <div class="input-group-addon">省级</div>
                                        <input style="min-width: 74px" type="number" name="province_bonus" value="<?php if($goods_info['bonus_rule_val'] && $goods_info['bonus_rule_val']['province_bonus']): ?><?php echo $goods_info['bonus_rule_val']['province_bonus']; endif; ?>" id="province_bonus" class="form-control area_bonus" min="0"  >
                                        <div class="input-group-addon">%,市级</div>
                                        <input style="min-width: 74px" type="number" name="city_bonus"  id="city_bonus" class="form-control area_bonus" min="0" value="<?php if($goods_info['bonus_rule_val'] && $goods_info['bonus_rule_val']['city_bonus']): ?><?php echo $goods_info['bonus_rule_val']['city_bonus']; endif; ?>" >
                                        <div class="input-group-addon">%,区级</div>
                                        <input style="min-width: 74px" type="number" name="district_bonus"  id="district_bonus" class="form-control area_bonus" value="<?php if($goods_info['bonus_rule_val'] && $goods_info['bonus_rule_val']['district_bonus']): ?><?php echo $goods_info['bonus_rule_val']['district_bonus']; endif; ?>" min="0" >
                                        <div class="input-group-addon">%</div>
                                    </div>
                                </td>
                                <?php endif; if($teamExist==1): ?>
                                <td class="bonus-td3 <?php if($goods_info['is_bonus_team']): if($goods_info['is_bonus_team']==2): ?>hide<?php endif; endif; ?>">
                                    <div class="input-group">
                                        <input style="min-width: 74px" type="number" name="team_bonus"  id="team_bonus" class="form-control team_bonus" min="0"  value="<?php if($goods_info['bonus_rule_val'] && $goods_info['bonus_rule_val']['team_bonus']): ?><?php echo $goods_info['bonus_rule_val']['team_bonus']; endif; ?>" >
                                        <div class="input-group-addon">%</div>
                                    </div>
                                </td>
                                <?php endif; ?>
        ...
        <div class="tab-pane fade tab-5" id="integral_rule">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group w-200">
                        <input type="number" class="form-control number-form-control" name="point_return_max" id="point_return_max" value="<?php echo $goods_info['point_return_max']; ?>"  min="0">
                        <div class="input-group-addon">%</div>
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group w-200">
                        <input type="number" class="form-control number-form-control" name="point_deduction_max" id="point_deduction_max" value="<?php echo $goods_info['point_deduction_max']; ?>"  min="0" max="100">
                        <div class="input-group-addon">%</div>
                    </div>
        ...
        <div class="tab-pane fade tab-7" id="discount_rule">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="checkbox_three">
                        <label class="checkbox-inline"><input type="checkbox" name="channel_level_all" id="channel_level_all" value="0"
                                                              <?php if($good_discount): if($good_discount['discount_channel_obj']['channel_level_id']): if($good_discount['discount_channel_obj']['channel_level_id'][0] !== 0): if(count($channel_level_list) == count($good_discount['discount_channel_obj']['channel_level_id'])): ?>checked<?php endif; endif; elseif($good_discount['discount_channel_obj']['channel_level_id'] === 0): else: ?> checked
                            <?php endif; endif; ?>
                            >全部</label>
                        ...
                        <label class="checkbox-inline channel_level">
                            <input type="checkbox" name="channel_level_id"  value="<?php echo $c1['channel_grade_id']; ?>"
                                   <?php if($good_discount['discount_channel_obj']): foreach($good_discount['discount_channel_obj']['channel_level_id'] as $m1): if($c1['channel_grade_id'] == $m1): ?> checked="checked" <?php endif; endforeach; endif; ?>>
                            <?php echo $c1['channel_grade_name']; ?>
                        </label>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                </div>
        ...
        <div class="tab-pane fade tab-6" id="wechat_card">
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <!--<?php if($goods_info['is_wxcard'] == '1'): ?><label class="radio-inline"><input type="radio" name="card_switch" id="card_model1" value="1" checked> 开启</label><?php endif; if($goods_info['is_wxcard'] == '2'): ?><label class="radio-inline"><input type="radio" name="card_switch" id="card_model2" value="2" checked> 关闭</label><?php endif; ?>-->
                    <div class="switch-inline">
                        <input type="checkbox" id="card_switch" name="card_switch" <?php if($goods_info['is_wxcard'] == '1'): ?>checked<?php endif; ?> onclick="return false;">
        ...
        <div class="tab-pane fade tab-5" id="goods_poster">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="switch-inline">
                        <input type="checkbox" id="is_goods_poster_open" name="is_goods_poster_open" <?php if($goods_info['is_goods_poster_open'] == 1): ?>checked<?php endif; ?>>
                            ...
                            <table style="width:80%;margin-left:130px;">
                                <tbody><tr>
                                    <td style="width:320px;" valign="top">
                                        <div id="poster" <?php if($goods_info['px_type'] == 2): ?> style="width:360px;height:640px;"<?php endif; ?>>
                                            <img src="" class="bg">
                                        </div>
                                    </td>
                                    <td valign="top">
                                            ...
                                            <div class="panel-body">
                                                <div class="form-group" id="pxselect">
                                                    ...
                                                    <label class="radio-inline" style="padding-left:38px;">
                                                        <input type="radio" name="pxselect" value="1" checked="" <?php if($goods_info['px_type'] == 1): ?>checked<?php endif; ?>> 640 * 1008
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="pxselect" value="2" <?php if($goods_info['px_type'] == 2): ?>checked<?php endif; ?>> 1080 * 1920
                                                    </label>
                                                </div>
    ...
    <div class="form-group">
        <label class="col-md-2 control-label"></label>
        <div class="col-md-8">
            <button class="btn btn-primary" type="submit" id="submitsData">保存</button>
...
<script>
    ...
    require(['util', 'platformAddgood', 'sotr-selector', 'poster'], function (util, platformAddgood) {
        var obj = <?php echo $goods_info; ?>;
        platformAddgood.goodsSkuCreate(obj);
