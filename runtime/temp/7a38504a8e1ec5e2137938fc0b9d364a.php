<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/www/wwwroot/www.tuandr.com/addons/discount/template/platform/getDiscountList.html";i:1583811702;}*/ ?>
...
<!-- page -->
<div class="mb-20">
    <a href="<?php echo __URL('PLATFORM_MAIN/addonslist/menu_addonslist?addons=addDiscount'); ?>" class="btn btn-primary"><i class="icon icon-add1"></i> 添加活动</a>
</div>
