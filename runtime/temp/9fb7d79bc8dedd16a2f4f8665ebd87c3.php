<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"template/platform/System/expressCompany.html";i:1591330114;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    function LoadingInfo(page_index) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo __URL('PLATFORM_MAIN/Express/expressCompany'); ?>",
            async: true,
            data: {
    ...
    function loading(){
            $.ajax({
                type:"get",
                url : "<?php echo __URL('PLATFORM_MAIN/config/setCompany'); ?>",
                async : true,
                success : function(data) {
                    $("#keyValue").val(data);
                }
