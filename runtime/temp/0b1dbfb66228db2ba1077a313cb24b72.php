<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"template/platform/Goods/attributelist.html";i:1591330108;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="v-main">
        <div class="v-container">
            ...
            <?php endif; ?>
                ...
                <!-- page -->
                <div class="mb-20">
                    <a href="<?php echo __URL('PLATFORM_MAIN/Goods/addAttributeService'); ?>" class="btn btn-primary"><i class="icon icon-add1"></i> 添加品类</a>
                </div>
...
require(['util'],function(util){
    ...
    function LoadingInfo(pageIndex) {
        ...
        $.ajax({
            type : "post",
            url : "<?php echo __URL('PLATFORM_MAIN/goods/attributelist'); ?>",
            async : true,
            data : {
                "pageIndex" : pageIndex
            },
                ...
                if (data["data"].length > 0) {
                    for (var i = 0; i < data["data"].length; i++) {
                        ...
                        if(data["data"][i]["is_use"]){
                            htnl += '<td><a href="javascript:void(0);" class="label label-success is_show" data-is_show="0" data-attr_id="'+data["data"][i]["attr_id"]+'">开启</a></td>';
                        }else{
                            htnl += '<td><a href="javascript:void(0);" class="label label-danger is_show" data-is_show="1" data-attr_id="'+data["data"][i]["attr_id"]+'">关闭</a></td>';
                        }
                        ...
                        htnl += '<a class="btn-operation edit" href="<?php echo __URL('PLATFORM_MAIN/goods/updateGoodsAttribute?attr_id='); ?>'+data["data"][i]["attr_id"]+'">编辑</a>';
    ...
    $('#attributeList').on('click','.delete_attr', function () {
        ...
        util.alert('确认删除此品类吗 ？', function () {
            $.ajax({
                type: "post",
                url: "<?php echo __URL('PLATFORM_MAIN/goods/deleteattr'); ?>",
                data: {
                    'attr_id': attr_id
                },
                success: function (data) {
    ...
    $('#attributeList').on('click', '.is_show', function(){
        ...
        var attr_id = $(this).data('attr_id');
            $.ajax({
                type: "post",
                url: "<?php echo __URL('PLATFORM_MAIN/goods/updateGoodsAttrShow'); ?>",
                data: {
    ...
    $("body").on('change', '.sort-form-control', function(){
        ...
        $.ajax({
            type : "post",
            url : "<?php echo __URL('PLATFORM_MAIN/Goods/setattributefield'); ?>",
            async : true,
