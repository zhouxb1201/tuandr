<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/www/wwwroot/www.tuandr.com/addons/bargain/template/admin/bargainGoodsDialog.html";i:1583811704;}*/ ?>
...
require(['util','tpl'],function(util,tpl){
    ...
    function LoadingInfo(page_index){
        ...
        $.ajax({
            type: "post",
            url: "<?php echo __URL('admin/addons/execute/addons/bargain/controller/Bargain/action/bargainDialogGoodsList'); ?>",
            async: true,
            data: {
