<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"template/platform/Member/memberLevelList.html";i:1591330110;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="v-main">
        <div class="v-container">
            ...
            <?php endif; ?>
                ...
                <!-- page -->
                <div class="mb-20">
                    <a href="<?php echo __URL('PLATFORM_MAIN/member/addmemberlevel'); ?>" class="btn btn-primary"><i class="icon icon-add1"></i> 添加等级</a>
                </div>
...
require(['util'],function(util){
    ...
    function getList(){
        $.ajax({
            type : "post",
            url : "<?php echo __URL('PLATFORM_MAIN/member/memberLevelList'); ?>",
            async : true,
            data : {},
    ...
    function delLevel(){
        $('.delLevel').on('click',function(){
            ...
            util.alert('是否删除该会员等级？',function(){
                $.ajax({
                    type : "post",
                    url : "<?php echo __URL('PLATFORM_MAIN/Member/deleteMemberLevel'); ?>",
                    async : true,
                    data : {
                        'level_id' : level_id
                    },
