<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/www/wwwroot/www.tuandr.com/addons/pcport/template/platform/customTemplateListPc.html";i:1591181823;}*/ ?>
                    ...
                    if (data.length > 0) {
                        for (var i = 0; i < data.length; i++) {
                            ...
                            if (curr.type == 'custom_templates') {
                                ...
                                html += '<a href="javascript:void(0);" data-clipboard-text="' + __URLS("SHOP_MAIN/index/custompage&suffix=" + curr.code + "&temp_type=" + curr.type + "&instance_id=<?php echo $instance_id; ?>") + '" class="btn-operation copy" data-id= "' + curr.code + '">复制链接</a>';
                                util.copy();
                            }
