<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:39:"template/platform/System/albumList.html";i:1591330114;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    $(function(){
        ...
        $('.add').on('click',function(){
            ...
            util.confirm('创建相册',html,function(){
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        if (data["code"] > 0) {
                            util.message(data["message"],'success',"<?php echo __URL('PLATFORM_MAIN/system/albumlist'); ?>");
                        }else{
                            util.message(data["message"],'error',"<?php echo __URL('PLATFORM_MAIN/system/albumlist'); ?>");
                        }
                    }
                })
            })
        ...
        $('.picture').on('click','.delete', function (e) {
            ...
            util.alert('确认删除此相册吗？', function () {
                $.ajax({
                    type : "post",
                    url : "<?php echo __URL('PLATFORM_MAIN/system/deleteAlbumClass'); ?>",
                    async : true,
                    data : {
        ...
        $('.picture').on('click','.edit',function(e){
            ...
            util.confirm('编辑相册',html,function(){
                ...
                $.ajax({
                    type : "post",
                    url : "<?php echo __URL('PLATFORM_MAIN/system/updateAlbumClass'); ?>",
                    async : true,
                    data : {
        ...
        $('.btn-file').click(function () {
            ...
            var url = "<?php echo __URL('PLATFORM_MAIN/upload/uploadFile'); ?>";
