<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/www/wwwroot/www.tuandr.com/addons/microshop/template/platform/shopkeeperList.html";i:1583811704;}*/ ?>
                                ...
                                <div class="v__control-group">
                                    ...
                                    <div class="v__controls">
                                        <select class="v__control_input" id="level" >
                                            ...
                                            <?php if(is_array($Shopkeeper_level) || $Shopkeeper_level instanceof \think\Collection || $Shopkeeper_level instanceof \think\Paginator): if( count($Shopkeeper_level)==0 ) : echo "" ;else: foreach($Shopkeeper_level as $key=>$value): ?>
...
<script>
    require(['util'],function(util){
        ...
        function getList(page_index){
            ...
            $.ajax({
                type : "post",
                url : '<?php echo $shopkeeperListUrl; ?>',
                async : true,
                data : {
