<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/www/wwwroot/www.tuandr.com/addons/paygift/template/admin/paygiftList.html";i:1583811704;}*/ ?>

        <!-- page -->
		<div class="mb-20">
            <a href="<?php echo __URL('ADDONS_ADMIN_MAINaddPaygift'); ?>" class="btn btn-primary"><i class="icon icon-add1"></i>添加活动</a>
