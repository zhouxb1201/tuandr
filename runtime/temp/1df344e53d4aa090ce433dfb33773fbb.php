<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:32:"template/admin/Auth/addUser.html";i:1583811758;s:24:"template/admin/base.html";i:1591103601;s:41:"template/admin/controlCommonVariable.html";i:1583811758;s:28:"template/admin/urlModel.html";i:1583811758;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="form-horizontal widthFixedForm" role="form" id="addUser" autocomplete="off">
    ...
    <div class="form-group add_back">
        ...
        <div class="col-md-7">
            ...
            <a href="<?php echo __URL('ADMIN_MAIN/auth/userlist'); ?>" class="btn back">返回</a>
        </div>
    </div>
</form>
<!-- page end -->
