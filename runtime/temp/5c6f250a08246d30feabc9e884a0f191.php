<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/www/wwwroot/www.tuandr.com/addons/bargain/template/admin/bargainRecord.html";i:1583811704;}*/ ?>


<ul id="bargain_type" class="nav nav-tabs v-nav-tabs fs-12">
    <li role="presentation" class="active" data-type="payed"><a href="javascript:void(0)" data-toggle="tab" class="flex-auto-center" aria-expanded="true">已支付<span class="J-all">(<?php echo $bargain_status_arr['pay_count']; ?>)</span></a></li>
    <li role="presentation" class="" data-type="going"><a href="javascript:void(0)" data-toggle="tab" class="flex-auto-center" aria-expanded="false">砍价中<span class="J-all">(<?php echo $bargain_status_arr['going_count']; ?>)</span></a></li>
    <li role="presentation" class="" data-type="fail"><a href="javascript:void(0)" data-toggle="tab" class="flex-auto-center" aria-expanded="false">砍价失败<span class="J-all">(<?php echo $bargain_status_arr['fail_count']; ?>)</span></a></li>
...
<script id="shop_curr_list" type="text/html">
    ...
    <tr>
        ...
        <td class="fs-0 operationLeft">
            <%if item.order_id!=0%>
            <a href="PLATFORM_MAIN/order/orderdetail?order_id=<%item.order_id%>" class="btn-operation" data-type="history">查看订单</a>
            <%/if%>
        </td>
    </tr>
    <%/each%>
