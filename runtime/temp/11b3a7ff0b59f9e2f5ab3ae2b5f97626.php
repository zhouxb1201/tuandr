<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"template/platform/Statistics/businessProfile.html";i:1591330113;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
require(['util'],function(util){
    ...
    function getOrderCount(){
        ...
        $.ajax({
            type : "post",
            url : "<?php echo __URL('PLATFORM_MAIN/Statistics/getOrderAccount'); ?>",
            async : true,
            data : {
    ...
    function loading(){
        ...
        $.ajax({
            type : "post",
            url : "<?php echo __URL('PLATFORM_MAIN/statistics/businessProfile'); ?>",
            async : true,
