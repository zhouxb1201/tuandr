<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:40:"template/platform/Config/editModule.html";i:1591330105;s:31:"template/platform/new_base.html";i:1591713031;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="content">
    <form class="form-horizontal form-validate pt-15">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input type="text" class="form-control" id="module_name" name="module_name" value="<?php echo $module_info['module_name']; ?>">
            </div>
        </div>
        <!--上级菜单-->
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input type="text" class="form-control" id="controller" value="<?php echo $module_info['controller']; ?>" name="controller">
            </div>
        </div>
        <!--方法名-->
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input type="text" class="form-control" id="method" value="<?php echo $module_info['method']; ?>" name="method">
            </div>
        </div>
        <!--URL-->
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input type="text" class="form-control" id="url" value="<?php echo $module_info['url']; ?>" name="url">
            </div>
        </div>
        <!--是否菜单-->
        <div class="form-group">
            ...
            <div class="col-md-3" style="margin-top: 6px">
                <input type="checkbox" id="is_menu"  name="is_menu" <?php if($module_info['is_menu'] == 1): ?> checked="checked" <?php endif; ?>>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3" style="margin-top: 6px">
                <input type="checkbox" id="is_control_auth"  name="is_control_auth" <?php if($module_info['is_control_auth'] == 1): ?> checked="checked" <?php endif; ?>>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input type="text" class="form-control" id="sort" value="<?php echo $module_info['sort']; ?>" name="sort">
            </div>
        </div>
        <!--矢量图class-->
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input type="text" class="form-control" id="icon_class" value="<?php echo $module_info['icon_class']; ?>" name="icon_class">
            </div>
        </div>
        <!--模板简述-->
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input type="text" class="form-control" id="editor" name="editor" value="<?php echo $module_info['desc']; ?>">
            </div>
        </div>
        <!--模板说明跳转-->
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input type="text" class="form-control" id="jump" name="jump" value="<?php echo $module_info['jump']; ?>">
            </div>
        </div>
...
<script>
    require(['util'],function(util) {
        util.validate($('.form-validate'),function(form){
            ...
            $.ajax({
                type: "post",
                url: "<?php echo __URL('PLATFORM_MAIN/System/editModule'); ?>",
                data: {
                    'module_id': module_id,
                    'pid': pid,
                ...
                success: function (data) {
                    if (data["code"] > 0) {
                        util.message('添加成功！', 'success', "<?php echo __URL('PLATFORM_MAIN/System/platformModule'); ?>");
                    } else {
