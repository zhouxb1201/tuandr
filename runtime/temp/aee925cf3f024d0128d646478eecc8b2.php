<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:37:"template/platform/Menu/addonmenu.html";i:1591330111;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<?php if($no_menu == '1'): else: if($second_menu_list && !$three_menu_list): ?>
<div class="v-subnav">
    ...
    <li>
        <a href="<?php echo __URL('PLATFORM_MAIN/'.$v1['url']); ?>" <?php if(strtoupper($v1['method']) == strtoupper($action)): ?> class="item active"<?php else: ?> class="item"<?php endif; ?>> <?php echo $v1['module_name']; ?></a>
    </li>
    <?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
    <?php endif; endforeach; endif; else: echo "" ;endif; ?>
</div>
<?php endif; if($three_menu_list): ?>
<div class="v-subnav">
    <!--<div class="v-subnav-title"><?php echo $second['module_name']; ?></div>-->
    <ul class="v-subnav-list block" id="menu_<?php echo $vo['module_id']; ?>" >
        <?php if(is_array($three_menu_list) || $three_menu_list instanceof \think\Collection || $three_menu_list instanceof \think\Paginator): $i = 0; $__LIST__ = $three_menu_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;
        ...
        $___session = session('addonmenu_menu_action');
         ...
         ?>
        <li>
            <a href="<?php echo __URL('PLATFORM_MAIN/'.$vo['url']); ?>" <?php if(strtoupper($vo['method']) == strtoupper($action)): ?> class="item active"<?php elseif((strtoupper($vo['method']) == strtoupper($___session))): ?> class="item parentactive2222255555"<?php else: ?> class="item"<?php endif; ?> > <?php echo $vo['module_name']; ?></a>
        </li>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
</div>
