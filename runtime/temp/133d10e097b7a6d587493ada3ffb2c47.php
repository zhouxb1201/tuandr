<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/www/wwwroot/www.tuandr.com/addons/store/template/admin/jobsList.html";i:1583811702;}*/ ?>

<div class="mb-20">
    <a href="<?php echo __URL('ADDONS_ADMIN_MAINaddJobs'); ?>" class="btn btn-primary"><i class="icon icon-add1"></i>添加岗位</a>
...
<script>
    require(['utilAdmin', 'tpl'], function (utilAdmin, tpl) {
        ...
        $('#jobs_list').on('click', '.btn-operation', function () {
            ...
            switch (type) {
                case 'edit':
                    location.href = __URL('ADDONS_ADMIN_MAINeditJobs&jobs_id=' + jobs_id);
                    break;
            }
        });
