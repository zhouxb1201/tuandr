<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:36:"template/platform/Auth/roleList.html";i:1591330103;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="v-container">
            ...
            <?php endif; ?>
                ...
                <div class="mb-20 flex flex-pack-justify">
                    <div class="">
                        <a href="<?php echo __URL('PLATFORM_MAIN/Auth/addAuthGroup'); ?>" class="btn btn-primary"><i class="icon icon-add1"></i> 添加角色</a>
                    </div>
...
require(['util'],function(util){
    ...
    function getAuthList(page_index){
        ...
        $.ajax({
            type : "post",
            url : "<?php echo __URL('PLATFORM_MAIN/auth/authGroupList'); ?>",
            async : true,
            data : {
    ...
    function del(){
        $('.del').click(function(e){
            ...
            util.alert('是否确定删除此角色吗？',function(){
                $.ajax({
                    type : "post",
                    url : "<?php echo __URL('PLATFORM_MAIN/Auth/deleteSystemUserGroup'); ?>",
                    async : true,
                    data : {
                        "group_id" : group_id
                    },
