<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/www/wwwroot/www.tuandr.com/addons/goodhelper/template/platform/goodImportHelper.html";i:1583811694;}*/ ?>
...
<script>
    require(['util'], function (util) {
        $('body').on('click','.J-progress', function () {
            location.href = "<?php echo __URL('PLATFORM_MAIN/System/plantask'); ?>";
        })
