<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:35:"template/platform/Auth/addRole.html";i:1583811744;s:31:"template/platform/new_base.html";i:1587970146;s:44:"template/platform/controlCommonVariable.html";i:1583811744;s:31:"template/platform/urlModel.html";i:1583811744;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <?php endif; ?>
                ...
                <form class="form-horizontal form-validate pt-15 widthFixedForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="role_name" required autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
                                ...
                                <div class="item_chek">
                                    <div class="checkbox">
                                        <label for="<?php echo $v1['module_id']; ?>">
                                            <input type="checkbox" value="<?php echo $v1['module_id']; ?>" id="<?php echo $v1['module_id']; ?>" name="module_id"><?php echo $v1['module_name']; ?>
                                        </label>
                                    </div>
                                    ...
                                    <div class="checkbox_seconds">
                                        <label for="<?php echo $v2['module_id']; ?>" class="checkbox-inline seconds-label">
                                            <input type="checkbox" id="<?php echo $v2['module_id']; ?>" value="<?php echo $v2['module_id']; ?>" name="module_id"><?php echo $v2['module_name']; ?>
                                        </label>
                                        ...
                                        <div class="checkbox_three item_content">
                                            ...
                                            <label for="<?php echo $v3['module_id']; ?>" class="checkbox-inline">
                                                <input type="checkbox" name="module_id" id="<?php echo $v3['module_id']; ?>" value="<?php echo $v3['module_id']; ?>" /><?php echo $v3['module_name']; ?>
                                            </label>
...
require(['util'],function(util){
    ...
    util.validate($('.form-validate'),function(form){
        ...
        if(select_box){
            $.ajax({
                type : "post",
                url : "<?php echo __URL('PLATFORM_MAIN/Auth/addAuthGroup'); ?>",
                data : {
