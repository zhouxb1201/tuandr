<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:38:"template/platform/Member/addUsers.html";i:1583811746;s:31:"template/platform/new_base.html";i:1587970146;s:44:"template/platform/controlCommonVariable.html";i:1583811744;s:31:"template/platform/urlModel.html";i:1583811744;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    require(['util'],function(util){
        ...
        util.validate($('.form-validate'),function(form){
			...
			$.ajax({
                    type : "post",
                    url : "<?php echo __URL('PLATFORM_MAIN/Member/register'); ?>",
                    async : true,
                    data : {
                        'mobile' : mobile,
                        'password' : password,
                    ...
                    success : function(data) {
                        if (data["code"] == 1) {
                            util.message(data["message"],'success',"<?php echo __URL('PLATFORM_MAIN/member/memberlist'); ?>");
                        }else if (data["code"] == 0) {
