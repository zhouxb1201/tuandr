<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"/www/wwwroot/www.tuandr.com/addons/shop/template/platform/shopAccountWithdrawList.html";i:1583811694;}*/ ?>
...
require(['util'],function(util){
    ...
    function getWithdrawList(page_index,status){
        ...
        $.ajax({
            type : "post",
            url : "<?php echo $shopAccountWithdrawListUrl; ?>",
            async : true,
            data : {
    ...
    $('body').on('click','.check_all',function(){
        ...
        util.alert(title, function () {
            $.ajax({
                type: "post",
                url: "<?php echo $shopAccountWithdrawAuditUrl; ?>",
                async: true,
                data: {
                    "id": check_id,
                    "status":status,
    ...
    function details(){
        $('.details').on('click',function(){
            ...
            $.ajax({
                type : "get",
                url : "<?php echo $shopAccountWithdrawInfoUrl; ?>",
                async : true,
                data : {
                    "id" : id
                },
    ...
    $('.dataExcel').on('click',function(){
        ...
        var website_id = <?php echo $website_id; ?>;
        window.location.href="<?php echo $shopAccountWithdrawListDataExcelUrl; ?>?website_id="+website_id+"&status="+status+"&start_date="+start_date+"&end_date="+end_date+"&search_text="+search_text;
    })
})
</script>
