<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"template/admin/Financial/reflectAccount.html";i:1583811758;s:24:"template/admin/base.html";i:1591103601;s:41:"template/admin/controlCommonVariable.html";i:1583811758;s:28:"template/admin/urlModel.html";i:1583811758;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="mb-20 flex flex-pack-justify">
    <div class="">
        <a href="<?php echo __URL('ADMIN_MAIN/Financial/addShopAccount'); ?>" class="btn btn-primary J-add"><i class="icon icon-add1"></i> 添加账户</a>
    </div>
</div>
<!--表格-->
...
//查询用户列表
    function LoadingInfo(page_index) {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo __URL('ADMIN_MAIN/Financial/shopAccountList'); ?>",
            async: true,
            data: {
    ...
    function Delete_bank(id,th) {
        $.ajax({
            type: "post",
            url: "<?php echo __URL('ADMIN_MAIN/financial/deleteaccount'); ?>",
            dataType: "json",
            data: {
                "id": id
            },
