<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:50:"template/platform/Express/freightTemplateList.html";i:1591330106;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<?php endif; ?>
    ...
    <div class="v-main">
        ...
        <div class="mb-20 flex flex-pack-justify">
            <div class="">
                <a href="<?php echo __URL('PLATFORM_MAIN/express/freightTemplateEdit?co_id='.$co_id); ?>" class="btn btn-primary"><i
...
<script>
    require(['util'], function (util) {
        ...
        function getList(page_index) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo __URL('PLATFORM_MAIN/express/freightTemplateList'); ?>",
                async: true,
                data: {
        ...
        function setDefault() {
            $('.setDefault').on('click', function () {
                ...
                util.alert('是否设为默认？', function () {
                    $.ajax({
                        type: "post",
                        url: "<?php echo __URL('PLATFORM_MAIN/Express/setDefaultShippingFee'); ?>",
                        async: true,
                        data: {
        ...
        function del() {
            $('.del').on('click', function () {
                ...
                util.alert('是否删除该运费模板？', function () {
                    $.ajax({
                        type: "post",
                        url: "<?php echo __URL('PLATFORM_MAIN/Express/freightTemplateDelete'); ?>",
                        async: true,
                        data: {
                            "shipping_fee_id": shipping_fee_id
                        },
