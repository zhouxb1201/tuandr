<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"template/platform/Goods/addGoodsCategory.html";i:1591330108;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="form-group J-cate">
                        ...
                        <div class="col-md-5">
                            <select class="form-control" id="pid">
                                ...
                                <option value="<?php echo $v1['category_id']; ?>" data-pid="<?php echo $v1['pid']; ?>" data-attr_id="<?php echo $v1['attr_id']; ?>" <?php if($category_id == $v1['category_id']): ?>selected<?php endif; ?>><?php echo $v1['short_name']; ?></option>
                                ...
                                <option value="<?php echo $v2['category_id']; ?>"  data-pid="<?php echo $v2['pid']; ?>" data-attr_id="<?php echo $v2['attr_id']; ?>" <?php if($category_id == $v2['category_id']): ?>selected<?php endif; ?>>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $v2['short_name']; ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <select class="form-control" id="attr_id">
                                ...
                                <option value="<?php echo $vo['attr_id']; ?>" <?php if($attr_id == $vo['attr_id']): ?>selected<?php endif; ?>><?php echo $vo['attr_name']; ?></option>
...
require(['util'],function(util){
    ...
    util.validate($('.form-validate'),function(form) {
        ...
        $.ajax({
                type: "post",
                url: "<?php echo __URL('PLATFORM_MAIN/goods/addgoodscategory'); ?>",
                data: {
