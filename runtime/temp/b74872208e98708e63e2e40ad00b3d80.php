<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:40:"template/platform/Goods/recycleList.html";i:1591330108;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="v-main">
        <div class="v-container">
            ...
            <?php endif; ?>
                ...
                <table class="table v-table table-auto-center" id="list">
                    <thead>
                        <tr>
...
require(['util'],function(util){
    ...
    $(function(){
        ...
        function LoadingInfo(pageIndex) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo __URL('PLATFORM_MAIN/goods/recyclelist'); ?>",
                async: true,
                data: {
                    "pageIndex": pageIndex,
            ...
            $('body').on('click', '.restore',function () {
                ...
                util.alert('确认要恢复此商品吗 ？', function () {
                    $.ajax({
                        type: "post",
                        url: "<?php echo __URL('PLATFORM_MAIN/goods/regaingoodsdeleted'); ?>",
                        data: {
                            'goodsId': goodsId
                        },
                        success: function (data) {
            ...
            $('body').on('click', '.delete', function () {
                ...
                util.alert('确认删除此商品吗 ？', function () {
                    $.ajax({
                        type: "post",
                        url: "<?php echo __URL('PLATFORM_MAIN/goods/emptydeletegoods'); ?>",
                        data: {
                            'goodsId': goodsId
                        },
                        success: function (data) {
