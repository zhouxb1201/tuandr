<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"/www/wwwroot/www.tuandr.com/addons/miniprogram/template/admin/mpCustomTemplateList.html";i:1583811700;}*/ ?>
    ...
    require(['utilAdmin', 'util'], function (utilAdmin, util) {
        ...
        $(function () {
            ...
            $('.J-add').on('click', function () {
                var url = "<?php echo $mpTemplateDialogUrl; ?>";
            ...
            $('#list').on('click', '.useCustomTemplate', function () {
                ...
                $.ajax({
                    type: "post",
                url: "<?php echo $useMpCustomTemplateUrl; ?>",
                    async: true,
                    data: {
                        "id": id,
                        "type": type
            ...
            $('#list').on('click', '.removeTemplate', function () {
                ...
                utilAdmin.alert('确定要删除该模板？', function () {
                    $.ajax({
                        type: "post",
                    url: "<?php echo $deleteMpCustomTemplateUrl; ?>",
                        data: {
                            "id": id
                        },
                        success: function (data) {
        ...
        function LoadingInfo(page_index) {
            ...
            $.ajax({
                ...
                url: "<?php echo $mpCustomTemplateListUrl; ?>",
                success: function (data) {
                    var html = "";
        ...
        function createNewTemplate() {
            ...
            if (template_name && template_name !== ' ') {
                $.ajax({
                    type: 'post',
                    // todo... 模板路径
                    url: '<?php echo $mpTemplateDialogUrl; ?>',
                    data: {
                        'type': template_type,
                    ...
                    success: function (res) {
                        if (res.code > 0) {
                            ...
                            utilAdmin.message(res.message, 'success', function () {
                                location.href = __URL("<?php echo $createCustomTemplateUrl; ?>?id=" + res.data.id);
                            });
                        } else {
