<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/www.tuandr.com/addons/seckill/template/platform/secKillList.html";i:1583811700;}*/ ?>


        <div class="mb-20">
            <a href="<?php echo __URL('ADDONS_MAINaddSecKill'); ?>" class="btn btn-primary"><i class="icon icon-add1"></i> 添加秒杀商品</a>
        </div>
