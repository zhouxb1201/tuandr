<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"/www/wwwroot/www.tuandr.com/addons/distribution/template/platform/lowerDistributorList.html";i:1586931646;}*/ ?>
...
<script>
    require(['util'],function(util){
        ...
        function getList(page_index) {
            ...
            $.ajax({
                type : "post",
                url : '<?php echo $lowerDistributorListUrl; ?>',
                async : true,
                data : {
