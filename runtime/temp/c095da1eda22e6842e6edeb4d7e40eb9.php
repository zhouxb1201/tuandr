<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"/www/wwwroot/www.tuandr.com/addons/distribution/template/platform/commissionWithdrawList.html";i:1583811698;}*/ ?>
...
require(['util'],function(util){
    ...
    function getWithdrawList(page_index){
        ...
        $.ajax({
            type : "post",
            url : "<?php echo $commissionWithdrawListUrl; ?>",
            async : true,
            data : {
    ...
    $('body').on('click','.check_all',function(){
        ...
        util.alert(title, function () {
            $.ajax({
                type: "post",
                url: "<?php echo $commissionWithdrawAuditUrl; ?>",
                async: true,
                data: {
                    "id": check_id,
                    "status":status,
    ...
    function details(){
        $('.details').on('click',function(){
            ...
            $.ajax({
                type : "GET",
                url : "<?php echo $commissionWithdrawInfoUrl; ?>",
                async : true,
                data : {
                    "id" : id
                },
    ...
    $('.dataExcel').on('click',function(){
        ...
        window.location.href="<?php echo $commissionWithdrawListDataExcelUrl; ?>?website_id="+website_id+"&status="+status+"&start_date="+start_date+"&end_date="+end_date+"&search_text="+search_text+"&withdraw_no="+withdraw_no;
    })
})
</script>
