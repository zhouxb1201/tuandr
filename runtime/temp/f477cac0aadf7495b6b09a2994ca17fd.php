<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"/www/wwwroot/www.tuandr.com/addons/bargain/template/platform/bargainGoodsDialog.html";i:1583811704;}*/ ?>
...
require(['util','tpl'],function(util,tpl){
    ...
    function LoadingInfo(page_index){
        ...
        $.ajax({
            type: "post",
            url: "<?php echo __URL('platform/addons/execute/addons/bargain/controller/Bargain/action/bargainDialogGoodsList'); ?>",
            async: true,
            data: {
        ...
        if(sku_list.sku_name === undefined || sku_list.sku_name !== ''){
            ...
            for(sku_ids in sku_list){
                ...
                html += '<td>'+sku_list[sku_ids]['price']+'</td>\n' +
                    ...
                    '<td><input type="number" min="1" step="1" name="all_money" class="form-control"></td>\n' +
                    '<td><input type="number" min="1" step="1"  name="first_money" class="form-control"></td>\n' +
                    '<td><input type="number" min="1" step="1"  name="presell_num" class="form-control"></td>\n' +
                    '<td><input type="number" min="1" step="1"  name="max_buy" class="form-control"></td>\n' +
                    '<td><input type="number" min="0" step="1"  name="dummy_num" class="form-control"></td>\n' +
            ...
            html += '<tfoot>\n' +
                    ...
                    '<a href="javascript:;" class="text-primary batchSet" data-batch_type="dummy_num">虚拟订购量</a>\n' +
                    '</td>\n' +
                    '</tr>\n' +
                    '</tfoot>';
