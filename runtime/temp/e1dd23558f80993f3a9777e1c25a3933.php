<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"template/platform/Goods/updateGoodsSpec.html";i:1591330109;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        font-size: 10px;
                ...
                <form class="form-horizontal pt-15 form-validate widthFixedForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="spec_name" name="spec_name" value="<?php echo $info['spec_name']; ?>" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label"><span class="text-bright">*</span>规格值</label>
                        <div class="col-md-5">
                            <textarea class="form-control" rows="8" id="spec_item" name="spec_item" required><?php echo $info['spec_value_name_list']; ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div class="checkbox_three">
                                <?php if(is_array($attribute_list) || $attribute_list instanceof \think\Collection || $attribute_list instanceof \think\Paginator): $i = 0; $__LIST__ = $attribute_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <label class="checkbox-inline category-pr">
                                    <input type="checkbox" name="attr_id" id="<?php echo $vo['attr_id']; ?>" value="<?php echo $vo['attr_id']; ?>" <?php if($vo['checked'] == '1'): ?> checked="checked" <?php endif; ?>><?php echo $vo['attr_name']; ?>
                                    <div class="category-pos">
                                        <div class="category-arrow">
                                            <p>对应分类：</p>
                                            <?php if(is_array($vo['categorys']) || $vo['categorys'] instanceof \think\Collection || $vo['categorys'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['categorys'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?>
                                            <p><?php echo $v1['category_names']; ?></p>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="sort" name="sort" value="<?php echo $info['sort']; ?>" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <div class="switch-inline">
                                <input type="checkbox" id="is_visible" name="is_visible" <?php if($info['is_visible'] == '1'): ?>checked="checked"<?php endif; ?>>
                    ...
                    <input type="hidden" name="seleted_attr" value="<?php echo $info['goods_attr_id']; ?>">
...
require(['util'],function(util){
    ...
    util.validate($('.form-validate'),function(form) {
        ...
        $.ajax({
            type : "post",
            url : "<?php echo __URL('PLATFORM_MAIN/goods/updategoodsspec'); ?>",
            data : {
                'spec_name' : spec_name,
                'sort' : sort,
            ...
            success : function(data) {
                if (data["code"] > 0) {
                    util.message('操作成功', "success","<?php echo __URL('PLATFORM_MAIN/goods/goodsspeclist'); ?>");
                } else {
