<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/www/wwwroot/www.tuandr.com/addons/bargain/template/platform/addBargain.html";i:1583811704;}*/ ?>
...
<form class="form-horizontal pt-15 form-validate widthFixedForm">
    ...
    <div class="form-group rand_bargain_money" style="display:none;">
        ...
        <div class="col-md-5">
            <div class="input-group w-400">
                <input class="form-control" type="number" placeholder="最低" min="0" step="0.01" name="rand_lowest_money" id="rand_lowest_money" value="<?php echo $bargain_info['rand_lowest_money']; ?>" required>
                <div class="input-group-addon"> ~ </div>
                <input class="form-control" type="number" placeholder="最高" min="0" step="0.01" name="rand_highest_money" id="rand_highest_money" value="<?php echo $bargain_info['rand_highest_money']; ?>" required>
                <div class="input-group-addon">元</div>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-5">
            <div class="input-group w-200">
                <input class="form-control" min="1" type="number" required name="bargain_num" id="bargain_num" value="<?php echo $bargain_info['bargain_stock']; ?>">
    ...
    <div id="sub_val">
        <div class="form-group">
            ...
            <div class="col-md-8">
                <?php if($bargain_id): ?>
                    <button class="btn btn-primary-diy" type="submit" id="submit">保存</button>
                <?php else: ?>
...
<script>
    require(['util'], function (util) {
        ...
        util.validate($('.form-validate'), function (form) {
            ...
            var bargain_num = $('#bargain_num').val();  //限购
            ...
            $.post('<?php echo $addBargain; ?>',
                ...
                function(res){
                    if (res["code"] > 0) {
                        util.message('添加成功', 'success', "<?php echo __URL('platform/Menu/addonmenu?addons=bargainList'); ?>");
        ...
        $('#selectGoods').click(function () {
            util.goodsDialog('url:/platform/addons/execute/addons/bargain/controller/Bargain/action/bargainDialogGoodsList',function(data){
            });
        });
        // 批量设置
