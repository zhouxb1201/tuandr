<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:47:"template/platform/Member/updateMemberLevel.html";i:1583811746;s:31:"template/platform/new_base.html";i:1587970146;s:44:"template/platform/controlCommonVariable.html";i:1583811744;s:31:"template/platform/urlModel.html";i:1583811744;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="v-main">
		...
		<form action="" class="form-horizontal form-validate pt-15 widthFixedForm">
			<div class="form-group">
				...
				<div class="col-md-5">
					<input type="text" class="form-control" id="level_name" name="level_name" value="<?php echo $info['level_name']; ?>" required>
				</div>
			</div>
			<?php if($info['is_default']!=1): ?>
			<div class="form-group">
				...
				<div class="col-md-5">
					<div class="input-group w-400">
						...
						<input type="number" id="growth_num" name="growth_num" class="form-control number-form-control " value="<?php echo $info['growth_num']; ?>" min="1" autocomplete="off" <?php if($info['is_default']!=1): ?>required<?php endif; ?>>
					</div>
			...
			<div class="form-group">
				...
				<div class="col-md-5">
					<input type="number" class="form-control" id="goods_discount" value="<?php echo $info['goods_discount']; ?>" min="0.01" max="10">
			...
			<div class="form-group">
				...
				<div class="col-md-5">
					<div class="switch-inline">
						<input type="checkbox" id="upgrade-switch" value="1" <?php if($info['is_label']): ?>checked<?php endif; ?> name="is_label">
			...
			<input type="hidden" id="level_id" value="<?php echo $info['level_id']; ?>">
		</form>
<input type="hidden" id="default_level_name" value="<?php echo $info['level_name']; ?>">
<input type="hidden" id="level_growth_num" value="<?php echo $level_growth_num; ?>">
<input type="hidden" id="default_growth_num" value="<?php echo $info['growth_num']; ?>">
...
<script>
    require(['util'],function(util){
        ...
        util.validate($('.form-validate'),function(form){
			...
			$.ajax({
                    type : "post",
                    url : "<?php echo __URL('PLATFORM_MAIN/Member/updateMemberLevel'); ?>",
                    async : true,
                    data : {
                        'level_id' : level_id,
                        'level_name' : level_name,
