<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:47:"template/admin/Financial/addReflectAccount.html";i:1583811758;s:24:"template/admin/base.html";i:1586931652;s:41:"template/admin/controlCommonVariable.html";i:1583811758;s:28:"template/admin/urlModel.html";i:1583811758;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="form-group bank_name">
            ...
            <div class="col-sm-5" >
                <select name="bank_name" id="bank_name"  class="form-control">
                    ...
                    <option value="<?php echo $v['bank_code']; ?>"><?php echo $v['bank_short_name']; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
...
require(['util','utilAdmin'], function (util,utilAdmin) {
    ...
    function addAccount() {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo __URL('ADMIN_MAIN/financial/addshopaccount'); ?>",
            data: {
                'type': type,
                'realname': realname,
                'bank_name': bank_name,
