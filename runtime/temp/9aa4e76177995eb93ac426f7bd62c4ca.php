<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"template/platform/System/operationLog.html";i:1591330114;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="mb-10 flex flex-pack-justify">
        ...
        <div class="flex">
            <select class="form-control select-form-control" id="uid">
                ...
                <?php if(is_array($userlist) || $userlist instanceof \think\Collection || $userlist instanceof \think\Paginator): if( count($userlist)==0 ) : echo "" ;else: foreach($userlist as $key=>$vs): ?>
                <option value="<?php echo $vs['uid']; ?>"><?php if($vs['user']): ?><?php echo $vs['user']; else: ?><?php echo $vs['admin_name']; endif; ?></option>
