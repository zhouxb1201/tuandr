<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/www/wwwroot/www.tuandr.com/addons/thingcircle/template/admin/thingcircleList.html";i:1583811702;}*/ ?>
            ...
            <div class="mb-10">
                <a class="btn btn-primary" href="<?php echo __URL('admin/Menu/addonmenu?addons=addThingcircle'); ?>"><i class="icon icon-add1"></i> 发布干货</a>
            </div>
...
<script>
    require(['utilAdmin'],function(utilAdmin){
        utilAdmin.layDate('#create_time',true,function(value, date, endDate){
                ...
                success : function(data) {
                    ...
                    if (data['data'].length>0) {
                        for (var i = 0; i < data['data'].length; i++) {
                            ...
                            html += '<a class="btn-operation edit" href="'+__URL('admin/Menu/addonmenu?addons=updateThingcircle&id='+ data['data'][i]['id']) +'" data-id="' + data['data'][i]['id'] +'">编辑</a>';

                            html += '<a class="btn-operation detail" href="'+__URL('admin/Menu/addonmenu?addons=thingcircleDetail&id='+ data['data'][i]['id']) +'" data-id="' + data['data'][i]['id'] +'" data-id="' + data['data'][i]['id'] +'">详情</a>';
                            ...
                            }else if(data['data'][i]["port"] == 'platform'){
        ...
        $('.search').on('click',function(){
            utilAdmin.initPage(getList(1));
        });
        $('body').on('click','.del',function(){
            var id = $(this).data('id');
            utilAdmin.alert('是否删除该干货？',function(){
                $.ajax({
                    type : "post",
