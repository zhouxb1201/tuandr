<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/www/wwwroot/www.tuandr.com/addons/channel/template/platform/channelGradeList.html";i:1583811706;}*/ ?>

<!-- page -->
<div class="mb-20">
    <a href="<?php echo __URL('ADDONS_MAINupdateChannelGrade'); ?>" class="btn btn-primary"><i class="icon icon-add1"></i> 添加等级</a>
</div>
...
<script>
    require(['util'],function(util){
        ...
        $('body').on('click','.save',function(){
            ...
            if(status==-1){
                util.alert('确定审核不通过？',function(){
                    $.ajax({
                        type : "post",
                        url : "<?php echo $setGlobalAgentStatusUrl; ?>",
        ...
        $('body').on('click','.delete',function(){
            ...
            $.ajax({
                type : "post",
                url : "<?php echo $deletaChannelGrade; ?>",
