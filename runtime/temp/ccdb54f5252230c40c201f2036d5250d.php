<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:48:"template/platform/System/versionInformation.html";i:1591330114;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form action="" class="form-horizontal">
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<div class="form-control-static"><?php echo $version_data['version_name']; ?></div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-md-8">
			<div class="form-control-static">
				<span class="mr-10"><?php echo $version_data['version_num']; ?></span>
				<?php if($version_data['version_status_code']==1  && $ismade == '否'): ?>
				<span class="text-red mr-10">检测到新版本：<?php echo $version_data['version_new_num']; ?></span>
				<?php endif; if($alllogs): ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<div class="form-control-static"><?php echo $version_data['version_introduction']; ?></div>
		</div>
	</div>
	<div class="form-group">
		<label class="col-md-2 control-label">开发者</label>
		<div class="col-md-8">
			<div class="form-control-static"><?php echo $version_data['developer']; ?></div>
		</div>
	</div>
	<div class="form-group">
...
<div style="display: none" id="aa">
	<div class="u-log">
		<?php if(is_array($version_data['version_log']) || $version_data['version_log'] instanceof \think\Collection || $version_data['version_log'] instanceof \think\Paginator): if( count($version_data['version_log'])==0 ) : echo "" ;else: foreach($version_data['version_log'] as $k=>$version_log): ?>
		<div class="u-log-item mb-10">
			<div class="u-log-title">
				<?php echo $version_log['version_num']; ?>
				<span><?php echo getTimeStampTurnTime($version_log['version_time'] ); ?></span>
			</div>
			<div class="u-log-content"><?php echo $version_log['update_ins']; ?></div>
		</div>
...
<div style="display: none" id="bb">
	...
	<p class="mb-10">2、请确保没有对团大人分销商城系统进行二开，如有二开请停止更新操作</p>
...
<input type="hidden" id="version_message" value="<?php echo $version_message; ?>">
    ...
    require(['util'], function (util) {
        ...
        $('.updateVersion').on('click',function(){
            ...
            util.confirm('更新须知',html,function(){
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo __URL('PLATFORM_MAIN/Versions/versionUpdate'); ?>",
                    async: true,
