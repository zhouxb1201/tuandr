<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:46:"template/platform/Member/memberLevelLists.html";i:1583811746;}*/ ?>
...
<script>
    require(['util'],function(util){
        ...
        function getList(){
            $.ajax({
                type : "POST",
                url : "<?php echo __URL('PLATFORM_MAIN/member/memberLevelLists'); ?>",
                data : {
                    "page_index" : 1,
                    "page_size" : 0
                },
