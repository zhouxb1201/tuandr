<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/www/wwwroot/www.tuandr.com/addons/groupshopping/template/admin/addGroupShopping.html";i:1583811704;}*/ ?>
        ...
        <form class="form-horizontal pt-15 form-validate widthFixedForm">
            <div class="screen-title">
             ...
             <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group w-200">
                        <input class="form-control" type="number" min="0" name="group_time" id="group_time" value="" required>
            ...
            <div id="four-select" class="hidden">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group w-200">
                            <input class="form-control ignore" min="1" type="number" name="group_limit_buy" id="group_limit_buy" value="" required>
    ...
    require(['util'], function (util) {
        ...
        util.validate($('.form-validate'), function (form) {
            ...
            $.post('<?php echo $addGroupShoppingUrl; ?>',
                    ...
                    function(res){
                    if (res["code"] > 0) {
                        util.message('添加成功', 'success', "<?php echo __URL('ADDONS_ADMIN_MAINgroupShoppingList'); ?>");
                    } else {
        ...
        $('#selectGoods').click(function () {
            util.goodsDialog('url:'+"<?php echo $modalGroupShoppingGoodsList; ?>",function(data){
            });
        });
        // 批量设置
