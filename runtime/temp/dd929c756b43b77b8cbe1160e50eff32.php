<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:36:"template/platform/Auth/editUser.html";i:1591330103;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <?php endif; ?>
                ...
                <form class="form-horizontal form-validate pt-15 widthFixedForm">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="number" required class="form-control"  id="mobile"  value="<?php echo $user_info['mobile']; ?>" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">使用人</label>
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="user" value="<?php echo $user_info['user']; ?>" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <select class="form-control" id="group_id">
                                ...
                                <option value="<?php echo $v1['group_id']; ?>" <?php if($v1['group_id'] == $user_info['group_id_array']): ?>selected<?php endif; ?>>&nbsp;&nbsp;<?php echo $v1['group_name']; ?></option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                    </div>

                    <input type="hidden" id="uid" value="<?php echo $user_info['uid']; ?>">
...
require(['util'],function(util){
    util.validate($('.form-validate'),function(form){
        ...
        $.ajax({
            type : "post",
            url : "<?php echo __URL('PLATFORM_MAIN/auth/editUser'); ?>",
            data : {
                'uid' : uid,
                'group_id' : group_id,
                'user': user,
