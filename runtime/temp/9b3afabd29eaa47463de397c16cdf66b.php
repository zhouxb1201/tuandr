<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/www.tuandr.com/addons/poster/template/platform/posterDialog.html";i:1583811698;}*/ ?>
    ...
    require(['util', 'tpl'], function (util, tpl) {
        ...
        function getSystemTemplateList() {
            $.ajax({
                type: "post",
                data: {},
                url: "<?php echo $posterSystemDefaultTemplateUrl; ?>",
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.code > 0) {
                        ...
                        console.log(res.data.poster_id);return;
