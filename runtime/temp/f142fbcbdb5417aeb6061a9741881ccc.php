<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/www/wwwroot/www.tuandr.com/addons/wheelsurf/template/admin/wheelsurfList.html";i:1583811696;}*/ ?>

        <!-- page -->
		<div class="mb-20">
            <a href="<?php echo __URL('ADDONS_ADMIN_MAINaddWheelsurf'); ?>" class="btn btn-primary"><i class="icon icon-add1"></i>添加大转盘</a>
...
<script id="shop_curr_list" type="text/html">
    ...
    <tr>
        ...
        <td class="fs-0 operationLeft">
            ...
            <!--<a href="javascript:;" class="btn-operation copy" data-clipboard-text="<?php echo $receiveUrl; ?>/<%item.wheelsurf_id%>">活动链接</a>-->
                    ...
                    <div class="link-arrow">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group"><label class="col-md-2 control-label">手机端</label>
                                <div class="col-md-10">
                                    <div class="input-group"><input class="form-control" type="text" disabled
                                                                    value="<%__URLS('SHOP_MAIN/wap/wheelsurf/centre/'+item.wheelsurf_id)%>"> <span
                                            class="input-group-btn btn btn-primary bbllrr0 copy"
                                            data-clipboard-text="<%__URLS('SHOP_MAIN/wap/wheelsurf/centre/'+item.wheelsurf_id)%>">复制链接</span> </div>
                                </div>
                            </div>
                            <%/if%>
                            ...
                            <div class="form-group"><label class="col-md-2 control-label">小程序端</label>
                                <div class="col-md-10">
                                    <div class="input-group"><input class="form-control" type="text" disabled
                                                                    value="package/pages/wheelsurf/wheelsurf?wheelsurfid=<%item.wheelsurf_id%>"> <span
                                            class="input-group-btn btn btn-primary bbllrr0 copy"
                                            data-clipboard-text="package/pages/wheelsurf/wheelsurf?wheelsurfid=<%item.wheelsurf_id%>">复制链接</span> </div>
                                </div>
                            </div>
                            <%/if%>
                        ...
                        <div class="flex link-flex">
                            ...
                            <div class="flex-1">
                                <div class="mb-04"><img
                                        src="<%__URL('admin/goods/getGoodsDetailQr')+'?wheelsurf_id='+item.wheelsurf_id +'&qr_type=1&wap_path=/wap/wheelsurf/centre/'%>" style="width: 100px;height: 100px">
                                </div>
                                <p>(手机端二维码)</p></div>
                            <%/if%>
                            <%if addon_status.is_minipro == 1%>
                            <div class="flex-1">
                                <div class="mb-04"><img
                                        src="<%__URL('admin/goods/getGoodsDetailQr')+'?wheelsurf_id='+item.wheelsurf_id +'&qr_type=2&mp_path=package/pages/wheelsurf/wheelsurf'%>" style="width: 100px;height: 100px">
                                </div>
                                <p>(小程序二维码)</p>
                            </div>
                            <%/if%>
        ...
        $('#wheelsurf_list').on('click', '.del', function () {
            var id = $(this).attr('data-id');
                utilAdmin.alert('删除？', function () {
                    $.ajax({
                        type: "post",
                        url: "<?php echo $deleteWheelsurfUrl; ?>",
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(tpl('shop_curr_list', data)){
                        $("#wheelsurf_list").html(tpl('shop_curr_list', data));
