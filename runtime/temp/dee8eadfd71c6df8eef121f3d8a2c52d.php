<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"/www/wwwroot/www.tuandr.com/addons/areabonus/template/platform/areaAgentLevelList.html";i:1583811698;}*/ ?>

		<div class="mb-20">
			<a href="<?php echo __URL('ADDONS_MAINaddAreaAgentLevel'); ?>" class="btn btn-primary"><i class="icon icon-add1"></i> 添加等级</a>
		</div>
...
<script>
    require(['util'],function(util){
        ...
        function getList(page_index) {
            ...
            $.ajax({
                type : "post",
                url : "<?php echo $areaAgentLevelListUrl; ?>",
                async : true,
                data : {
        ...
        function del(){
            $('.del').on('click',function(){
                ...
                util.alert('确定删除该等级？',function(){
                    $.ajax({
                        type : "post",
                        url : "<?php echo $deleteAreaAgentLevelUrl; ?>",
                        data : {
                            'id' : id
                        },
                        async : true,
