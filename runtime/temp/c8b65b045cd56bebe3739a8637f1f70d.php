<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"/www/wwwroot/www.tuandr.com/addons/areabonus/template/platform/areaBonusProfile.html";i:1583811698;}*/ ?>

		<!-- page -->
		<div class="flex-auto-center mb-20 bg-info text-center border-info">
			<div class="flex-1 padding-15">
				<h3 class="strong">区域代理总数</h3>
				<p id="agent_total"></p>
			</div>
			<div class="flex-1 padding-15">
				<h3 class="strong">今日新增区域代理</h3>
				<p id="agent_today"></p>
			</div>
			<div class="flex-1 padding-15">
				<h3 class="strong">区域代理分红</h3>
				<p id="total_bonus"></p>
			</div>
			<div class="flex-1 padding-15">
...
<script>
    require(['util'],function(util){
        ...
        function getOrderCount(){
            $.ajax({
                type : "post",
                url : "<?php echo $areaBonusProfileUrl; ?>",
                async : true,
        ...
        function  showCharts(){
            ...
            $.ajax({
                type : "post",
                url : "<?php echo $areaBonusOrderProfileUrl; ?>",
                async : true,
                data : {'website_id':<?php echo $website_id; ?>},
