<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"/www/wwwroot/www.tuandr.com/addons/store/template/admin/addStore.html";i:1586931646;}*/ ?>
        ...
        util.validate($('.form-validate'), function (form) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data["code"] > 0) {
                        util.message(data["message"], 'success', "<?php echo __URL('ADDONS_ADMIN_MAINstoreList'); ?>");
                    } else {
