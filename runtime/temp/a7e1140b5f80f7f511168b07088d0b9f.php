<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"template/platform/Finance/accountList.html";i:1591330107;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div class="v__control-group">
                                    ...
                                    <div class="v__controls">
                                        <select class="v__control_input" id="form_type" >
                                            ...
                                            <?php if($globalStatus==1 ||  $areaStatus==1 ||  $teamStatus==1): ?>
                                            <option value="11">分红提现</option>
                                            <?php endif; if($distributionStatus==1): ?>
                                            <option value="12">分销提现</option>
                                            <?php endif; if($microshopStatus==1): ?>
...
<script>
    require(['util'],function(util){
        ...
        function getAccountList(page_index){
            ...
            $.ajax({
                type : "post",
                url : "<?php echo __URL('PLATFORM_MAIN/Finance/accountList'); ?>",
                async : true,
                data : {
