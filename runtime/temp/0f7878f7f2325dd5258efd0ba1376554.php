<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/www/wwwroot/www.tuandr.com/addons/microshop/template/platform/profitRecordsList.html";i:1583811704;}*/ ?>
                        ...
                        <div class="v__control-group">
                            ...
                            <div class="v__controls">
                                <select class="v__control_input" id="from_type">
                                    ...
                                    <option value="4">收益提现</option>
                                    <option value="22">开店返利</option>
                                </select>
                            </div>
                        </div>
...
<script>
    require(['util'],function(util){
        ...
        function getAccountList(page_index){
            ...
            $.ajax({
                type : "post",
                url : "<?php echo $profitRecordsListUrl; ?>",
                async : true,
                data : {
                ...
                success : function(data) {
                    ...
                    if (data["data"].length > 0) {
                        for (var i = 0; i < data["data"].length; i++) {
                            ...
                            html += '<td><a class="text-primary block send" href="javascript:;" data-id="' + data["data"][i]["id"]+ '">流水详情</a></td>';
                            html += '</tr>';
                        }
                    } else {
            ...
            $('.send').on('click',function(){
                ...
                $.ajax({
                    ...
                    success : function(list) {
                        ...
                        html += "<div class='col-md-8'>";
                        html += "<p class='form-control-static'>"+list[0]['user_name']+"</p>";
                        html += "</div>";
                        html += "</div>";
                        html += "<div class='form-group'>";
                        ...
                        html += "<div class='col-md-8'>";
                        html += "<p class='form-control-static'>"+list[0]['profit']+"</p>";
                        html += "</div>";
                        html += "</div>";
                        html += "<div class='form-group'>";
        ...
        $('.dataExcel').on('click',function(){
            ...
            window.location.href="<?php echo $profitRecordsDataExcelUrl; ?>&from_type="+from_type+"&records_no="+records_no+"&start_date="+start_date+"&end_date="+end_date+"&search_text="+search_text+"&website_id="+website_id;
        })
    })
</script>
