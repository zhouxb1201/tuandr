<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"template/platform/Member/addMemberLabel.html";i:1591330110;s:31:"template/platform/new_base.html";i:1591713031;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    require(['util'],function(util) {
        ...
        util.validate($('.form-validate'),function(form){
            ...
            $.ajax({
                type: "post",
                url: "<?php echo __URL('PLATFORM_MAIN/member/addLabel'); ?>",
                data: {
                    'group_name': group_name,
                    'is_label': is_label,
