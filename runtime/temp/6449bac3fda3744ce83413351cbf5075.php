<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/www.tuandr.com/addons/store/template/platform/storeList.html";i:1587970154;}*/ ?>

<div class="mb-20">
    <a href="<?php echo __URL('ADDONS_MAINaddStore'); ?>" class="btn btn-primary"><i class="icon icon-add1"></i>添加门店</a>
