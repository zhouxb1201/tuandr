<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"template/platform/common/pictureDialog.html";i:1591330104;}*/ ?>
    ...
    require(['util'], function (util) {
        $(function () {
            ...
            $('.picture-dialog').on('click', '.album_category', function () {
                ...
                localStorage.setItem("platform_album_id_<?php echo $website_id; ?>", $(this).data('album_id'));
                util.initPage(changedpic, 'page-pictureDialog');
            });
            // 点击上传图片
        ...
        function selectAlbum() {
            var album_id = localStorage.getItem("platform_album_id_<?php echo $website_id; ?>");
            $.ajax({
                type: "post",
                ...
                success: function (data) {
                    ...
                    if (data["data"].length > 0) {
                        for (var i = 0; i < data["data"].length; i++) {
                            if (album_id) {console.log(album_id);
        ...
        $('#createAlbum').on('click', function () {
            ...
            util.confirm('创建相册', html, function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data) {
                            localStorage.setItem("platform_album_id_<?php echo $website_id; ?>", data["code"]);
