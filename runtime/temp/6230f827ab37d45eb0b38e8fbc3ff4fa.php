<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"template/platform/Goods/editGoodsBrand.html";i:1591330108;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="form-horizontal pt-15 widthFixedForm" id="goods_brand_form" name="form">
    ...
    <input type="hidden" name="brand_id" id="brand_id" value="<?php echo $brand_info['brand_id']; ?>">
    <div class="form-group">
        <label class="col-md-2 control-label"><span class="text-bright">*</span>品牌名称</label>
        <div class="col-md-5">
            <input type="text" class="form-control" id="brand_name" name="brand_name" value="<?php echo $brand_info['brand_name']; ?>" autocomplete="off">
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-2 control-label"><span class="text-bright">*</span>首写字母</label>
        <div class="col-md-5">
            <input type="text" class="form-control" id="brand_initial" name="brand_initial" value="<?php echo $brand_info['brand_initial']; ?>" required maxlength="1" autocomplete="off">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-5">
            <div class="switch-inline">
                <input type="checkbox" id="brand_recommend" <?php if($brand_info['brand_recommend'] == 1): ?>checked<?php endif; ?>>
                       <label for="brand_recommend" class=""></label>
            </div>
        </div>
    </div>
    <input type="hidden" id="category_name" name="category_name" value="<?php echo $brand_info['category_name']; ?>">
    <div class="form-group">
        ...
        <div class="col-md-5">
            <div class="picture-list">
                <a href="javascript:void(0);" class="close-box">
                    ...
                    <img src="<?php echo $brand_info['brand_pic']; ?>">
                    <?php else: ?>
                    <div class="picture-list">
    ...
    <div class="form-group">
        ...
        <div class="col-md-5">
            <input type="number" class="form-control" id="sort" name="sort" value="<?php echo $brand_info['sort']; ?>">
        </div>
    </div>
    <div class="form-group">
...
require(['util'], function (util) {
    ...
    $(".add_brand").on('click', function () {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo __URL('PLATFORM_MAIN/goods/updategoodsbrand'); ?>",
            data: {
                'brand_id': brand_id,
            ...
            success: function (data) {
                if (data["code"] > 0) {
                    util.message('商品品牌修改成功', "success", "<?php echo __URL('PLATFORM_MAIN/goods/goodsbrandlist'); ?>");
                } else {
    ...
    $('.multiPicture').on('click', function () {
        util.confirm('图片空间', 'url:<?php echo __URL('PLATFORM_MAIN/goods/pic_space'); ?>', function () {
