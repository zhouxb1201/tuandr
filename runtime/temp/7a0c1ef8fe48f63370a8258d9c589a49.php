<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:33:"template/admin/Auth/editUser.html";i:1583811758;s:24:"template/admin/base.html";i:1591103601;s:41:"template/admin/controlCommonVariable.html";i:1583811758;s:28:"template/admin/urlModel.html";i:1583811758;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<form class="form-horizontal widthFixedForm" role="form">
    ...
    <div class="form-group">
        ...
        <div class="col-md-8">
            <input type="number" class="form-control" id="mobile" name="mobile"  value="<?php echo $ua_info['mobile']; ?>" title="请输入手机号" required autocomplete="off">
        </div>
    </div>
    <!--使用人-->
    <div class="form-group">
        ...
        <div class="col-md-8">
            <input type="text" class="form-control" id="user" name="user" value="<?php echo $ua_info['user']; ?>" autocomplete="off">
        </div>
    </div>
    <!--角色下拉框-->
    <div class="form-group">
...
//添加用户
    function editUserAjax() {
        ...
        if (!flag) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo __URL('ADMIN_MAIN/auth/edituser'); ?>",
                data: {
                    'group_id': group_id,
                    'uid' : uid,
                    'user': user,
