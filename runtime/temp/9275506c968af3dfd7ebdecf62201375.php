<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/www/wwwroot/www.tuandr.com/addons/customform/template/platform/addCustomForm.html";i:1583811704;}*/ ?>
    ...
    util.validate($('.form-validate'), function (form) {
        ...
        $.ajax({
            ...
            success: function (data) {
                // console.log(data);
                if (data["code"] > 0) {
                    util.message(data["message"], 'success', "<?php echo __URL('ADDONS_MAINcustomFormList'); ?>");
                } else {
