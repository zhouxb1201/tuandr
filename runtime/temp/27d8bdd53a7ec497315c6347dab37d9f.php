<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:88:"/www/wwwroot/www.tuandr.com/addons/groupshopping/template/admin/updateGroupShopping.html";i:1583811704;}*/ ?>
        ...
        <form class="form-horizontal pt-15 form-validate widthFixedForm">
            ...
            <input type="hidden" name="group_id" id="group_id" value="<?php echo $group_id; ?>">
             <div class="form-group">
                ...
                <div class="col-md-5">
                    <input type="text" name="group_name" id="group_name" required maxlength="4" class="form-control" value="<?php echo $groupDetail['group_name']; ?>" autocomplete="off">
             ...
             <div class="form-group">
                ...
                <div class="col-md-5">
                    <input type="number" name="group_num" id="group_num" min="2" max="10" required class="form-control" value="<?php echo $groupDetail['group_num']; ?>" autocomplete="off">
             ...
             <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        <input class="form-control" type="number" name="group_time" id="group_time" value="<?php echo $groupDetail['group_time']; ?>" required>
                ...
                <div class="col-md-5">
                    <div class="media text-left">
                        <div class="media-left goods-img">
                            <img  src="<?php echo __IMG($groupDetail['goods']['pic_cover_mid']); ?>" onerror="this.src='http://iph.href.lu/60x60';" width="60" height="60">
                        </div>
                        <div class="media-body max-w-300">
                            <div class="line-2-ellipsis goods-text"><?php echo $groupDetail['goods']['goods_name']; ?></div>
                            <div class="line-1-ellipsis text-danger strong goods-price"><?php echo $groupDetail['goods']['price']; ?></div>
                        </div>
                    </div>
                    <input type="hidden" name="goods_id" id="goods_id" value="<?php echo $groupDetail['goods_id']; ?>">
                </div>
            </div>
            <div id="product_sku">
                <div class="form-group">
            ...
            <!--<div class="form-group">-->
                ...
                <!--<div class="col-md-5">-->
                    <!--<label class="radio-inline">-->
                        <!--<input type="radio" name="status" value="1" <?php if($groupDetail['status']=='1'): ?> checked <?php endif; ?>> 进行中-->
                    <!--</label>-->
                    <!--<label class="radio-inline">-->
                        <!--<input type="radio" name="status" value="2" <?php if($groupDetail['status']=='2'): ?> checked <?php endif; ?>> 已结束-->
                    <!--</label>-->
                <!--</div>-->
            <!--</div>-->
             <?php if($groupDetail['status']!='2'): ?>
            <div id="sub_val">
                <div class="form-group">
                    <label class="col-md-2 control-label"></label>
                    <div class="col-md-8">
             ...
             <?php endif; ?>
            <div id="sku_list" data-sku_list="<?php echo $groupDetail['sku_list']; ?>"></div>
        </form>
...
<script>
    require(['util'], function (util) {
        ...
        util.validate($('.form-validate'), function (form) {
            ...
            // console.log(data);return;
            $.post('<?php echo $addGroupShoppingUrl; ?>',
                    data,
                    function(res){
                    if (res["code"] > 0) {
                        util.message('修改成功', 'success', "<?php echo __URL('ADDONS_ADMIN_MAINgroupShoppingList'); ?>");
                    } else {
