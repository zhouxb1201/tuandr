<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:37:"template/admin/Login/retrievePwd.html";i:1591322839;}*/ ?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>重置密码 - <?php if($logo_config['title_word']): ?><?php echo $logo_config['title_word']; else: ?>团大人 - 让更多的人帮你卖货！<?php endif; ?></title>
            ...
            <div class="w1200">
                <div class="edit-content">
                        ...
                        <div class="fp-box">
                            <div class="login-box">
                                ...
                                <dl class="clearfix">
                                    ...
                                    <dd class="userName-ipt fl"><input type="number" id="mobile" class="inputs" autocomplete="off"  placeholder="请输入手机号码"  value=""></dd>
                                </dl>
                                <dl class="clearfix">
                                    <dt class="userName fl"><img src="PLATFORM_STATIC/login_register/code.png" alt=""></dt>
                                    <dd class="userName-ipt fl pr">
                                        <input type="password" class="inputs" id="mobile-code"  autocomplete="off" placeholder="请输入验证码">
                    ...
                    <div class="validation-step3 tc" style="display: none">
                        <p>恭喜您，修改密码成功！</p>
                        <p><a href="<?php echo __URL('ADMIN_MAIN/login?website_id='.$website_id); ?>" class="blue">重新登录</a></p>
                    </div>
                </div>
...
<script>
    require(['dialog'],function(dialog){
        ...
        $("#mobile").change(function(){
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo __URL('ADMIN_MAIN/login/retrievePwd?website_id='.$website_id); ?>",
        ...
        $(".sendcode").click(function(){
            ...
            if(mobile){
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo __URL('ADMIN_MAIN/login/forgotValidation?website_id='.$website_id); ?>",
        ...
        $(".next1").click(function(){
            ...
            if(mobile && mobile_code ){
                $.ajax({
                    type : "post",
                    url : "<?php echo __URL('ADMIN_MAIN/login/check_find_password_code'); ?>",
                    async : false,
        ...
        $(".next2").click(function(){
            ...
            $.ajax({
                type : "post",
                url : "<?php echo __URL('ADMIN_MAIN/login/setNewPassword'); ?>",
                data : {"userInfo":mobile,"password":mobile_pass, "website_id":'<?php echo $website_id; ?>'},
                success : function(data){
                    if(data['code'] >0){
