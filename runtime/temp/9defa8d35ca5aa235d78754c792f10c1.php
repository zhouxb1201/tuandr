<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/www/wwwroot/www.tuandr.com/addons/qlkefu/template/platform/qlkefuSetting.html";i:1583811694;}*/ ?>
        ...
        util.validate($('.form-validate2'), function (form) {
            ...
            $.ajax({
                ...
                success:function (data) {
                    if (data['code'] > 0) {
                        util.message(data["message"], 'success',function(){
                        	window.location.href="<?php echo __URL('ADDONS_MAINqlkefuSetting'); ?>";
        				});
                    } else {
                        util.message(data["message"], 'danger',function(){
                        	flag = false;
