<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"template/platform/Finance/bonusRecordList.html";i:1591330107;s:31:"template/platform/new_base.html";i:1592227919;s:44:"template/platform/controlCommonVariable.html";i:1591330104;s:31:"template/platform/urlModel.html";i:1591330114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
			...
			<div class="v-form-inline ">
				<div class="form-group">
					...
					<select class="form-control" id="bonus_type">
						<option value="">请选择类型</option>
						<?php if($globalStatus==1): ?>
						<option value="1">全球分红</option>
						<?php endif; if($areaStatus==1): ?>
						<option value="2">区域分红</option>
						<?php endif; if($teamStatus==1): ?>
...
<script>
    require(['util'],function(util){
        ...
        function getAccountList(page_index){
            ...
            $.ajax({
                type : "post",
                url : "<?php echo __URL('PLATFORM_MAIN/Finance/bonusRecordList'); ?>",
                async : true,
                data : {
                ...
                success : function(data) {
                    ...
                    if (data["data"].length > 0) {
                        for (var i = 0; i < data["data"].length; i++) {
                            ...
                            html += '<td><a class="btn-operation send" href="javascript:void(0);" data-id="' + data["data"][i]["id"]+ '" >详情</a></td>';
                            html += '</tr>';
                        }
                    } else {
