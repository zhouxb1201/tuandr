...
//        }
    ...
    public function logisticsInfo()
    {
        ...
        $result = getShipping($no,$com,'auto',$this->website_id);
        return $result;
    }
        ...
        if (input('post.order_id')) {
            ...
            if(intval(input('post.order_goods_id'))){
                ...
                foreach ($logistics_list as $v){
                    $return_data[] = getShipping($v['refund_shipping_code'],$v['refund_shipping_company'],'auto',$this->website_id);
                }
            }else{
                ...
                foreach ($logistics_list as $v){
                    $return_data[] = getShipping($v['express_no'],$v['express_company_id'],'auto',$this->website_id);
                }
            }
            return $return_data;
        }
