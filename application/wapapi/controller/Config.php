...
class Config extends BaseController
{
    ...
    public function index()
    {
        ...
        $config_array = ['SEO_TITLE', 'SEO_META', 'SEO_DESC', 'LOGINVERIFYCODE', 'BPAY', 'ALIPAY','DPAY','TLPAY','ETHPAY','EOSPAY','WPAY', 'WCHAT', 'QQLOGIN', 'EMAILMESSAGE', 'MOBILEMESSAGE', 'WITHDRAW_BALANCE', 'GPPAY'];
