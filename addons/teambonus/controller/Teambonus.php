...
use addons\bonus\model\VslAgentLevelModel as AgentLevelModel;
        ...
        public function teamBasicSetting()
        {
            ...
            if (request()->isPost()) {
                ...
                $retval = $config->setTeamBonusSite($teambonus_status,$agent_condition, $agent_conditions, $pay_money,$number,$one_number,$two_number,$three_number, $order_money, $agent_check, $agent_grade, $goods_id,$purchase_type,$gradation_status,$agent_data,$up_team_money);
                if($retval){
