...
class TeamBonus extends BaseService
{
    ...
    public function getAgentInfo($uid)
    {
        ...
        $result['apply_team_agent_time'] = date('Y-m-d H:i:s',$result['apply_team_agent_time']);
     ...
     * 团队分红设置
     */
    public function setTeamBonusSite($teambonus_status,$agent_condition, $agent_conditions, $pay_money,$number,$one_number,$two_number,$three_number, $order_money, $agent_check, $agent_grade, $goods_id,$purchase_type,$gradation_status,$agent_data,$up_team_money)
    {
        $account = new VslBonusAccountModel();
