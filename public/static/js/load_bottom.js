	...
	$.ajax({
		...
		success : function(data) {
			...
			if($is_load>0){
				...
				$("#copyright_companyname").attr("href", "http://www.vslai.com");
				$("#copyright_companyname").html("广州领客信息科技股份有限公司&nbsp;提供技术支持");
				$("#copyright_desc").html("Copyright © 2018 广州领客信息科技股份有限公司&nbsp;版权所有 保留一切权利");
			}else{
