...
<div class="hd_main store_hd_main">
    ...
    <div class="navs">
        <div class="w w1200 lyrow" data-mode="nav_mode" data-purebox="nav_mode">
            <div class="nav_main">
                <ul class="clearfix" data-type="range"><!--店铺头部-->
<!--店铺头部-->
<!-- 首页菜单导航模态框 -->
<!-- 首页菜单导航模态框 -->
<!--首页菜单导航回调-->
...
<!--精选好店-->
<!--精选好店-->
<div class="spec" data-spec="{&quot;navname&quot;:[],&quot;navurl&quot;:&quot;&quot;,&quot;opennew&quot;:[],&quot;navid&quot;:[]}"></div></ul>
            </div>
            <div class="setup_box" data-html="not">
                <div class="barbg"></div>
...
<div class="w w1200">
    ...
    <div class="goodsright_2"><img src="ADMIN_IMG/decorate/goodsright_2.png" alt=""></div><!--占位3-->
        <div class="demo ui-sortable" data-area="J-detailbanner" type="goodst" style="min-height: 655px; background-color: transparent; display: inline-block;float: left;width: 80%;min-width:80%; ">
</div>
<div class="goodsleft_2"></div>
<div class="clearfix"></div>
</div>
<div class="demo ui-sortable" data-area="J-detail" style="display:block;min-height:68px;">
    
</div>
<div class="clearfix"></div>
                                <input type="hidden" value="goods_templates_tpl_1" id="code">
                <input type="hidden" value="goods_templates" id="type">
